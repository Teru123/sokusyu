//
//  HukusyuFourDetailViewController.m
//  sokusyu-eitango
//
...
@interface HukusyuFourDetailViewController ()

@end

@implementation HukusyuFourDetailViewController
...
- (void)viewDidLoad
{
    ...
    navigationTitle.topItem.title = [NSString stringWithFormat:@"%@", wordNameForString];

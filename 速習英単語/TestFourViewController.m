...
- (void)viewDidLoad
{
    ...
    */
    ...
    if ([wordNo isEqualToString:@"1"]) {
        ...
        word6.name = @"bottom";
        word6.detail =  @"名詞 複 ～s/-z/\n一番下, 最下部; ふもと; 降りたところ, 下\n\n底\nThere are tea leaves in the ___ of my cup.\nコップの底に茶葉があります。\n\n末席, 下っ端; びり, 最下位 \nHe was always ___ of the class in maths.\n彼の数学の成績はいつもクラスで最下位だった。\n\n奥; 行き止まり; 端\n\n原因, 根本; 真相\n\n形容詞\n底の; 底にいる\nPut your books on the ___ shelf.\n本を棚の一番下に置いてください。";
        word6.hatuon = @"bɑ́təm|bɔ́t-";
        word6.reibun = @"There are tea leaves in the bottom of my cup.     He was always bottom of the class in maths.     Put your books on the bottom shelf.";
        ...
        word14.name = @"moment";
        word14.detail =  @"名詞 複～s/-ts/\n瞬間, 短時間; ちょっと, しばらく \nI'll be back in a ___.\nすぐに戻ります。\nWould you take a seat for a ___?\n少しの間座って頂けますか？\n\n時期, 機会; 場合\nThe big ___ has come at last!\nついにこの時が来た！";
        word14.hatuon = @"móʊmənt";
        word14.reibun = @"I'll be back in a moment.     Would you take a seat for a moment?     The big moment has come at last!";
        ...
        word16.name = @"promise";
        word16.detail =  @"動詞～s/-ɪz/; ～d/-t/; -ising\n他動詞\n~すると約束する[請け合う]; ~ということを約束する; ~ということを楽しみにする\nI ___ never to reveal his secret.\n秘密は漏らさないと約束する。\n\n~を与えると約束する\n~を心待ちにする\n\n~すると約束する\n\n事が起こりそうなことを示す; ~しそうである\n\n見込みがある\n\n名詞 複～es/-ɪz/\n約束 ; 約束\nOnce he made a ___, he would stick to it.\n彼は約束した事を守る。\nI have committed myself and must keep my ___.\n承諾した以上、約束は守らなければならない。\n\n見込み, 有望; 気配, 兆し";
        word16.hatuon = @"prɑ́məs|prɔ́m-";
        word16.reibun = @"I promise never to reveal his secret.     Once he made a promise, he would stick to it.     I have committed myself and must keep my promise.";
        ...
        /*
         ...
         word25.name = @"create";
         word25.detail =  @"動詞～s/-ts/; ～d/-ɪd/; -ating\n他動詞\n神、自然が物、事を創造する, 造る; 人が新しいものを創作[創設, 開発]する, 生み出す\n\n事態、状態を引き起こす";
         ...
         word35.name = @"scare";
         word35.detail =  @"動詞～s/-z/; ～d/-d/; __ing/skéərɪŋ/\n他動詞\n~を怖がらせる, おびえさせる, ぎょっと[はっと]させる\n\n~を怖がらせて~させる\n\n~を立ちのかせる, 離れさせる\n\n~を引き離す, 敬遠させる\n\n名詞\n恐怖\n\n不安, 恐れ";
         word35.hatuon = @"skeər";
         ...
         word38.name = @"smell";
         word38.detail =  @"動詞～s/-z/; ～ed/-d/, smelt/smelt/; ～ing\n他動詞\n人が~のにおいがする; においで~ということに気づく; ~するにおいがする \n\n~のにおいをかぐ\n\n自動詞\n~のにおいがする; ~の香りがする\n\nいやなにおいがする, 悪臭を放つ\n\nにおいを識別できる, 嗅覚がある\n\n違法である, 不正である\n\n名詞 複～s/-z/\nにおい, 香り; 悪臭";
         word38.hatuon = @"smel";
         ...
         word56.name = @"solve";
         word56.detail =  @"動詞～s/-z/; ～d/-d/; __ing\n他動詞\n問題、難局を解決する, 処理する, 打開する\n\nなぞを解く, 解明する; 問題を解答する";
         ...
         word63.name = @"behave";
         word63.detail =  @"動詞～s/-z/; ～d/-d/; behaving\n自動詞\nふるまう, 行動する  ; 行儀よくする\n\n他動詞\n行動する, ふるまう; 子供が行儀よくする";
        ...
        words = [NSMutableArray arrayWithObjects:
                 ...
                 word14, word15, word16, word17, word18, word19, word20,/* word21, word22, word23, word24, word25,
                                                                         word26, word27, word28, word29, word30, word31, word32, word33, word34, word35, word36, word37,
                                                                         word38, word39, word40, word41, word42, word43, word44, word45, word46, word47, word48, word49,
                                                                         word50, word51, word52, word53, word54, word55, word56, word57, word58, word59, word60, word61,
                                                                         word62, word63, word64, word65, word66, word67, word68, word69, word70, word71, word72, word73,
                                                                         word74, word75, word76, word77, word78, word79, word80, word81, word82, word83, word84, word85,
    ...
    if ([wordNo isEqualToString:@"6"]) {
        ...
        /*
         ...
         word22.detail =  @"動詞～s/-ɪz/; ～d/-t/; __ing\n他動詞\n~を知らせる, 通知[公告, 告知, 発表]する\n\n~であると発表する\n\n~を知らせる, 取り次ぐ\n\n~を告げる, アナウンスする";
         ...
         TestWord *word59 = [TestWord new];
         word59.name = @"tear";
         word59.detail =  @"動詞～s/-z/; tore/tɔːr/; torn/tɔːrn/;～ing/téərɪŋ/\n他動詞\n~を引き裂く, 破る; ~を引き裂いてあるにする; 穴を開ける\n\n~を引き裂いて[引きちぎって]~にする\n\n~を引きはがす, 破り取る, 引き離す\n\n分裂する, ばらばらになる  ; 人が心を引き裂かれる, 傷つく\n\n自動詞\n紙が裂ける, 破れる; 穴が開く\n\n引っぱる, 引き裂こうとする\n\n大急ぎで動く, 疾走[突進]する";
         word59.hatuon = @"teər";
    ...
    if ([wordNo isEqualToString:@"11"]) {
        ...
        /*
         ...
         word51.detail =  @"動詞～s/-ɪz/; ～d/-t/; __ing\n自動詞\n増える, 増加[増大]する\n\n他動詞\nを増やす, 高める\n\n名詞 複～s/-ɪz/\n 増加, 上昇; 増加量";
         ...
         TestWord *word55 = [TestWord new];
         word55.name = @"raise";
         word55.detail =  @"動詞～s/-ɪz/; ～d/-d/; __ing\n他動詞\n物、体の一部を上げる\n\n旗を掲げる; 物を立てる, 人を起こす\n\n人が身を起こす, 起き上がる\n\n料金、数値、賃金を上げる, 増やす\n\n質、水準を向上させる, 上げる\n\n子供を育てる, 養育する\n\n家畜を飼育する; 作物を栽培する\n\n金を募る; 資金を集める\n\n~を提起する; 質問、異議を出す\n\n恐怖、疑惑を引き起こす; 笑みを生じさせる\n\n声を張り上げる; 警報を鳴らす\n\n封鎖、包囲を解く, 解除する\n\n数字を累乗する\n\n水ぶくれを作る; パンをふくらませる\n\n名詞\n昇給額, 賃上げ";
         word55.hatuon = @"reɪz";
         ...
         TestWord *word82 = [TestWord new];
         word82.name = @"breathe";
         word82.detail =  @"動詞～s/-z/; ～d/-d/; __ing\n自動詞\n息をする, 呼吸する;息を吹きかける\n\n息をつく, 休む\n\n他動詞\n\n呼吸する;を吸い込む; 吐き出す;においを吐きかける";
         word82.hatuon = @"briːð";
         ...
         TestWord *word92 = [TestWord new];
         word92.name = @"observe";
         word92.detail =  @"動詞～s/-z/; ～d/-d/; __ing\n他動詞\n~に気付く, ~が見てわかる ;~しているのを目撃する, のに気付く\n\n~であることに気付く\n\n観察する, 観測する, 見守る, 監視する\n\n法律、契約、習慣を守る\n\n気付いたことを述べる, 陳述する";
    ...
    if ([wordNo isEqualToString:@"16"]) {
        ...
        /*
         ...
         TestWord *word41 = [TestWord new];
         word41.name = @"argue";
         word41.detail =  @"動詞～s/-z/; ～d/-d/; arguing\n自動詞\n~のことで論争する; 言い争う, 口論する\n\n理由を挙げて~に賛成[反対]の主張をする, 論を述べる\n\n他動詞\n理由を挙げて~だと主張する, 論じる\n\n理由を挙げて主張、事を論じる, 議論する\n\nを説得する";
         ...
         TestWord *word67 = [TestWord new];
         word67.name = @"explore";
         word67.detail =  @"動詞～s/-z/; ～d/-d/; __ing/-plɔ́ːrɪŋ/\n他動詞\nを探検する, 踏査[探査]する; ~を求めて 場所を調査する\n\n~を探究する, 検討する, 探る; ~かを調べる\n\n自動詞\n資源を求めて探検する, 踏査する";
    ...
    if ([wordNo isEqualToString:@"21"]) {
        ...
        /*
         ...
         TestWord *word36 = [TestWord new];
         word36.name = @"receive";
         word36.detail =  @"動詞～s/-z/; ～d/-d/; __ing\n他動詞\n~を受け取る, 受領する\n\n支持、注目を集める; 教育、待遇を受ける\n\n手紙、電話を受け取る, 情報を受ける\n\nけが、損害をこうむる; 重みを支える\n\n治療を受ける\n\n受け入れられる, 迎えられる; 考えがみなされる\n\nを迎え入れる\n\nを受信する\n\n~が無線で聞こえる";
         ...
         TestWord *word39 = [TestWord new];
         word39.name = @"steal";
         word39.detail =  @"動詞～s/-z/; stole/stoʊl/; stolen/stóʊl(ə)n/; ～ing\n盗む; 盗用する\n\nこっそり盗み見、キスをする; ~をこっそり動かす";
         word39.hatuon = @"stiːl";
         
         TestWord *word40 = [TestWord new];
         word40.name = @"thief";
         word40.detail =  @"名詞 複__ves/θiːvz/\n泥棒, こそどろ";
         word40.hatuon = @"θiːf";
         ...
         TestWord *word55 = [TestWord new];
         word55.name = @"remove";
         word55.detail =  @"動詞～s/-z/; ～d/-d/; __ing\n他動詞\n取り去る, 移動する, 撤去する\n\n~を取り除く, 除去する; しみ、汚れを落とす\n\n~から降ろす, 解雇する, 解任する\n\n名詞\n距離, 隔たり, 程度";
         ...
         TestWord *word59 = [TestWord new];
         word59.name = @"swim";
         word59.detail =  @"動詞～s/-z/; __am/__æm/; __um; ～ming\n自動詞\n泳ぐ, 水泳する\nつかっている ; あふれている\n\nくらくらする; ぐるぐる回って見える\n\nなめらかに動く\n\n他動詞\n~で泳ぐ; 競泳に参加する\n\n~を泳ぐ, 泳ぎ渡る\n\n名詞 複～s/-z/\nひと泳ぎ, 水泳; 泳ぐ時間";
         word59.hatuon = @"swɪm";
         ...
         TestWord *word76 = [TestWord new];
         word76.name = @"strike";
         word76.detail =  @"動詞～s/-s/; __ruck/__rʌk/; __ing\n他動詞\n~をぶつける; 当てる; ~にぶつかる, 当たる\n\nマッチをする, マッチをすって火をつける\n\n雷が~に落ちる, ~を打つ\n\n病気、災難が~を襲う\n\n時刻を打つ, 鳴らす\n\n考えが~の心に浮かぶ\n\n~の心を打つ, ~を驚かせる, ~に感銘を与える\n\n~であると思わせる; 目に付く\n\n感情、態度を表明する\n\n驚いて~になる; 非常に驚く\n\n金鉱、石油を掘り当てる, ~に偶然行き当たる\n\n釣り合いをとる\n\n取引をする\n\n光が~に当たる\n\nポーズをとる\n\nテント、帆をたたむ, 降ろす\n\n自動詞\nストライキをする\n\n雷が落ちる\n\n突然襲いかかる, 打撃を与える\n\n病気、災難が突然襲う, 起こる\n\n打つ, たたく\n\n名詞複～s/-s/\nストライキ, 同盟罷業\n\n攻撃\n\n 石油を掘り当てること";
         ...
         TestWord *word80 = [TestWord new];
         word80.name = @"unite";
         word80.detail =  @"動詞～s/-ts/; ～d/-ɪd/; __ing\n他動詞\n結合させる, 統合する\n\n団結させる, 結束させる\n\n併せ持つ";
    ...
    if ([wordNo isEqualToString:@"26"]) {
        ...
        /*
         TestWord *word21 = [TestWord new];
         word21.name = @"bite";
         word21.detail =  @"動詞～s/-ts/; bit/bɪt/; bitten/bɪ́t(ə)n/; biting\n他動詞\nかむ, ~にかみつく, ~をかみちぎる\n\n~を刺す; ~をはさむ\n\n寒さがにしみる; 霜が~をいためる; 酸が金属を腐食する\n\n自動詞\n食いつく; かみつく; かみ切る\n\n名詞 複～s/-ts/\nかむこと, かじること; 魚釣りのあたり\n\nかみ傷, 刺し傷.\n\n少量;ひと口, ひとかじり";
         word21.hatuon = @"baɪt";
         ...
         TestWord *word98 = [TestWord new];
         word98.name = @"imply";
         word98.detail =  @"動詞implies/-z/; implied/-d/; ～ing\n他動詞\n~をそれとなく示す, 暗に意味する, ほのめかす; ~だとそれとなく示す\n\n~を意味する; ~という結論になる\n\n当然必要とする, 必ず伴う[含む]";
         word98.hatuon = @"ɪmpláɪ";
        ...
        words = [NSMutableArray arrayWithObjects:
                 ...
                 word14, word15, word16, word17, word18, word19, /* word21, word22, word23, word24, word25,
                                                                  word26, word27, word28, word29, word30, word31, word32, word33, word34, word35, word36, word37,
                                                                  word38, word39, word40, word41, word42, word43, word44, word45, word46, word47, word48, word49,
                                                                  word50, word51, word52, word53, word54, word55, word56, word57, word58, word59, word60, word61,
                                                                  word62, word63, word64, word65, word66, word67, word68, word69, word70, word71, word72, word73,

...
- (void)visibleRowsBeginAnimation:(WaveAnimation)animation
{
    ...
    for (int i=0 ; i < [array count]; i++) {
        ...
        [self performSelector:@selector(animationStart:) withObject:array afterDelay:0.03*i];
    }
}
...
- (void)animationStart:(NSArray *)array
{
    ...
    CGPoint beginPoint = CGPointMake(cell.frame.size.width*i*-1, originPoint.y);
    ...
    move.keyTimes=@[[NSNumber numberWithFloat:0.0],[NSNumber numberWithFloat:0.5],[NSNumber numberWithFloat:0.8],[NSNumber numberWithFloat:1.0]];

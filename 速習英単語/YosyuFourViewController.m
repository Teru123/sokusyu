...
@implementation YosyuFourViewController
...
- (void)viewDidLoad
{
    ...
    if ([wordNo isEqualToString:@"1"]) {
        changeLabel = [NSArray arrayWithObjects:
                       ...
                       /*@"adventure", @"approach", @"carefully", @"chemical", @"create", @"evil", @"experiment", @"kill",
                        ...
                        @"terrible", @"worse", @"alien", @"among", @"chart", @"cloud", @"comprehend", @"describe", @"ever",
                        @"fail", @"friendly", @"grade", @"instead", @"library", @"planet", @"report", @"several", @"solve",
                        @"suddenly", @"suppose", @"universe", @"view", @"appropriate", @"avoid", @"behave", @"calm", @"concern",
                        @"content", @"expect", @"frequently", @"habit", @"instruct", @"issue", @"none", @"patient", @"positive",
                        @"punish", @"represent", @"shake", @"spread", @"stroll", @"village", @"aware", @"badly", @"belong",
        ...
        changeHatuonLabel = [NSMutableArray arrayWithObjects:
                             ...
                             @"pliːzd", @"prɑ́məs|prɔ́m-", @"rɪpláɪ", @"seɪf", @"trɪk", @"wel",/* @"ədvén(t)ʃər", @"əpróʊtʃ",
                                                                                                 @"kéərf(ə)li", @"kémɪk(ə)l", @"kriéɪt", @"íːv(ə)l", @"ɪkspérɪmənt", @"kɪl",
                                                                                                 @"lǽb(ə)rətɔ̀ːri|ləbɔ́rət(ə)ri", @"læf|lɑːf", @"laʊd", @"nə́ːrvəs", @"nɔɪz", @"prɑ́dʒèkt|prɔ́-, prə́ʊ-",
                                                                                                 @"skeər", @"síːkrət", @"ʃaʊt", @"smel", @"térəb(ə)l", @"wəːrs", @"éɪliən, -jən", @"əmʌ́ŋ",
                                                                                                 @"tʃɑːrt", @"klaʊd", @"kɑ̀mprɪhénd|kɔ̀m-", @"dɪskráɪb", @"évər", @"feɪl", @"frén(d)li", @"ɡreɪd",
                                                                                                 @"ɪnstéd", @"láɪbrèri|-br(ə)ri, -b(ə)ri", @"plǽnɪt", @"rɪpɔ́ːrt", @"sévr(ə)l", @"sɑlv|sɔlv",
                                                                                                 @"sʌ́d(ə)nli", @"səpóʊz", @"júːnɪvə̀ːrs", @"vjuː", @"əpróʊpriət", @"əvɔ́ɪd", @"bɪhéɪv",
                                                                                                 @"kɑːm", @"kənsə́ːrn", @"kəntént", @"ɪkspékt, eks-", @"fríːkwəntli", @"hǽbɪt", @"ɪnstrʌ́kt",
                                                                                                 @"ɪ́ʃuː", @"nʌn", @"péɪʃ(ə)nt", @"pɑ́zətɪv|pɔ́z-", @"pʌ́nɪʃ", @"rèprɪzént", @"ʃeɪk", @"spred",
                                                                                                 @"stroʊl", @"vɪ́lɪdʒ", @"əwéər", @"bǽdli", @"bɪlɔ́ːŋ|-lɔ́ŋ", @"kəntɪ́njuː", @"érər",
                                                                                                 @"ɪkspɪ́əriəns, eks-", @"fiːld", @"həːrt", @"dʒʌ́dʒmənt", @"láɪkli", @"nɔ́ːrm(ə)l", @"reər",
                                                                                                 @"rɪlǽks", @"rɪkwést", @"rɪzáɪd", @"rɪzʌ́lt", @"roʊl", @"sɪns", @"vɪ́zəb(ə)l", @"waɪld",*/ nil];
        ...
        changeText = [NSMutableArray arrayWithObjects:
                      ...
                      @"副詞better/bétər/; best/best/\n上手に, うまく; 申し分なく; 適切に\n\n十分に, よく\nI can't sleep well because the tap is dripping.\n水道の蛇口の水漏れがうるさくてよく眠れなかった。",
                      /*
                       @"名詞 複～s/-z/\n冒険, 冒険旅行; 非日常的な出来事[経験]\n\n冒険心; 危険を冒すこと",
                       @"動詞～es/-ɪz/; ～ed/-t/; ～ing\n他動詞\n人、場所に近づく, 接近する\n\n頼む, 話をもちかける, 接触する\n\n出来事、時期に近づく, ~を迎える\n\n段階、状況に到達しようとする, ~の域に近づく, ~に匹敵する;<否定文で>~には程遠い\n\n問題、課題に取りかかる, 着手する\n\n自動詞\n近づく, 接近する; 出来事、時期が近づく, もうすぐやってくる\n\n名詞 複～es/-ɪz/\n取り組み方, 手法, 研究方法, アプローチ\n\n近づくこと, 接近\n\n近づく[通じる]道, 入口, 進入路\n\n依頼, 打診, 申し出",
                       @"副詞more ～; most ～\n注意深く, 丁寧に読む/見る, 綿密に, 入念に計画する、調査する\n\n慎重に選ばれた、組み立てられた, 綿密[入念]に計画、準備、管理された\n\n注意深く聞く, 慎重に考える, 言葉を選ぶように言う\n\n注意して, 気をつけて, 慎重に移動する、置く、開ける",
                       @"形容詞\n化学(上)の, 化学的な; 化学用の; 化学的に作られた; 化学薬品の[による] \n\n名詞 複～s/-z/\n化学薬品[製品]; 化学物質",
                       ...
                       @"名詞 複-ries/-z/\n実験室; 試験所; 研究所; 実験室での, 実験用の",
                       @"動詞～s/-s/; ～ed/-t/; ～ing\n自動詞\n笑う; あざ笑う, 嘲笑する; 軽視する\n\n笑う, 笑いたい気持ちになる\n\n他動詞\n~な笑い方をする \n\n笑って~~になる\n\n人を笑って舞台から降ろす; 人を笑って~にする; 人を笑って~をやめさせる\n\n名詞 複～s/-s/\n笑い; 笑い声",
                       @"形容詞～er; ～est\nうるさい, やかましい, 騒々しい\n\n色、模様がけばけばしい, 派手な, 俗悪な\n\n副詞～er; ～est\n大声で, 大きな音で",
                       @"形容詞more ～; most ～\n心配して, 不安で, びくびくして; 自信のない\n\n神経質な, 神経過敏な, 過度に緊張[いらいら]した人、行動; 臆病な, 不安な; 動揺しやすい; 緊迫した; 不安からくる意識、反応\n\n神経の, 神経性の, 神経に作用する",
                       @"名詞 複～s/-ɪz/\n騒音, 雑音, 物音; 騒ぎ声; 騒々しさ; 音\n\n雑音, ノイズ",
                       @"名詞 複～s/-ts/ \n事業計画, プロジェクト, 企画\n\n研究課題, 自主研究\n\n動詞/prədʒékt/～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n~を見積もる; ~だと推測する; ~すると予測する; ~と見積もられている\n\n映像を映写する; 影、光を投げる, 輪郭を映す ; 声をはっきり大きく出す\n\n~を他人に伝える; ~という印象を与える",
                       @"動詞～s/-z/; ～d/-d/; scaring/skéərɪŋ/\n他動詞\n~を怖がらせる, おびえさせる, ぎょっと[はっと]させる\n\n~を怖がらせて~させる\n\n~を立ちのかせる, 離れさせる\n\n~を引き離す, 敬遠させる\n\n名詞\n恐怖\n\n不安, 恐れ",
                       @"形容詞more ～; most ～\n秘密の, 内密の; 知られていない; 人目につかない場所\n\n外に表れない, 隠れた感情; 内奥の\n\n口がかたい ; こそこそやる\n\n名詞 複～s/-ts/\n秘密; 機密; 内緒\n\n秘訣; 秘伝, こつ\n\n不思議, 神秘, なぞ",
                       @"動詞～s/-ts/; ～ed/-ɪd/; ～ing\n自動詞\n叫ぶ; 大声を出す ; 大声で言う, どなる\n\n他動詞\n~を叫ぶ;~を大声で言う ; ~ということをどなる, わめく; \n\n名詞 複～s/-ts/\n叫び, 大声, 歓声, 怒号",
                       @"動詞～s/-z/; ～ed/-d/, smelt/smelt/; ～ing\n他動詞\n人が~のにおいがする; においで~ということに気づく; ~するにおいがする \n\n~のにおいをかぐ\n\n自動詞\n~のにおいがする; ~の香りがする\n\nいやなにおいがする, 悪臭を放つ\n\nにおいを識別できる, 嗅覚がある\n\n違法である, 不正である\n\n名詞 複～s/-z/\nにおい, 香り; 悪臭",
                       ...
                       @"形容詞\nいくつかの, いくらかの, 数人[個]の\n\nそれぞれの, 個々の; いろいろな\n\n代名詞\nいくらかのもの, いくつか",
                       @"動詞～s/-z/; ～d/-d/; solving\n他動詞\n問題、難局を解決する, 処理する, 打開する\n\nなぞを解く, 解明する; 問題を解答する",
                       @"副詞more ～; most ～\n突然, いきなり, 不意に",
                       @"動詞～s/-ɪz/; ～d/-d/; -posing\n他動詞\n~することになっている, ~しなければならない\n\n~と判断する, ~であろうと思う, ~と想定[推察, 推定]する\n\n~を~だと思う\n\n~としたらどうだろうか; 仮に~としよう ; ~が~であるとすれば \n\n~というのはどうでしょうか",
                       @"名詞 複～s/-ɪz/\n宇宙; 万物, 森羅万象\n\n分野, 領域, 世界; 生活",
                       @"名詞 複～s/-z/\n意見, 考え, 見解\n\n見方, 考え方\n\n視界, 視野; 視力\n\n見えること\n\n見る[観察する]こと ; 検分\n\n眺め; ~図\n\n意図, 目的, 意向\n\n見通し, 見込み\n\n動詞\n他動詞\n~を見る, 眺める; ~を調査[検分]する\n\n~を~であると考える[見なす]\n\n~を見る, 考察する",
                       
                       @"形容詞more ～; most ～\nきちんと合った, 適切な, ふさわしい\n\n動詞/-èɪt/～s/-ts/; ～d/-ɪd/; -ating\n他動詞\n~を私物化する; 金品を横領[着服]する\n\n金銭を充当する, 使用する",
                       @"動詞～s/-dz/; ～ed/-ɪd/; ～ing\n他動詞\n事故、危険な事態を避ける, 防ぐ\n\n人、視線、話題を避ける, 場所に近寄らないようにする; ~しないようにする",
                       @"動詞～s/-z/; ～d/-d/; behaving\n自動詞\nふるまう, 行動する  ; 行儀よくする\n\n他動詞\n行動する, ふるまう; 子供が行儀よくする",
                       @"形容詞～er; ～est\n人、心、態度が落ち着いた, 冷静な; 社会情勢が平穏な\n\n天候が風のない, 平穏な\n\n名詞～s/-z/\n平穏, 静けさ; 無風状態, なぎ\n\n平静, 平穏, 冷静\n\n動詞\n他動詞\n~を静める, 穏やかにする, なだめる",
                       @"名詞 複～s/-z/\n心配事, 心配の種, 懸念材料\n\n心配, 懸念, 不安\n\n心遣い, 配慮, 思いやり\n\n思い入れ ; 重要と見なすこと\n\n関心事, 関心の対象\n\n重要な事, 問題\n\n関係, 関連 ; 利害関係, 出資すること\n\n責務, 責任, 任務\n\n動詞～s/-z/; ～ed/-d/; ～ing \n他動詞\n~に関係する, 影響を与える, 重要である; かかわる, 関与[関係]する\n\n~を心配させる; 気にかける\n\n本、話が~にかかわる, ~についてのものである",
                       @"形容詞more ～; most ～\n満足して, 甘んじて\n\n喜んで~する, 甘んじて~する\n\n動詞\n他動詞\n満足する, 甘んじる",
                       @"動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n~を予想[予期]する; ~するつもりである, ~することを予想[予期]する\n\n~するだろうと思う\n\n~が来る[起こる]だろうと思う\n\n~を要求する, 求める ; ~するように要求する, 求める\n\n~を期待する; ~することを期待する, ~してもらいたいと思う\n\n赤ちゃんを産む予定である\n\n自動詞\n妊娠している",
                       @"副詞more ～; most ～\nしばしば, たびたび, 頻繁に",
                       @"名詞 複～s/-ts/\n習慣, 癖\n\n酒、タバコの常用, 中毒; 麻薬中毒[依存癖]",
                       @"動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n人に指示を与える;~するよう指示する, 命じる\n; 人に~と命じる\n\n人に教える\n\n~と知らせる",
                       @"名詞 複～s/-z/\n社会問題の争点, 論点; 問題、議論の核心\n\n社会的な問題, 気がかり\n\n雑誌、新聞の~号, 版\n\n動詞～s/-z/; ～d/-d/; issuing\n他動詞\n声明を出す, 発する\n\nパスポートを発行する, 衣服、弾薬を支給する, 給与する, 渡す ; ~を支給する \n\n令状を発布する, 公布する",
                       @"代名詞\n3者以上のうちだれも[だれ1人として]~ない, ~のうち何も[何1つとして]~ない\n\n何も[何1つとして]~ない, だれも[だれ1人として]~ない\n\nひとつも[少しも]ない, 全然ない\n\n副詞\nまったく[少しも]~でない\n\nまったく[少しも]~でない, ~どころではない",
                       @"名詞 複～s/-ts/\n患者, 病人\n\n形容詞more ～; most ～\n人が忍耐強い, 我慢[根気]強い ; 態度が辛抱強い",
                       @"形容詞more ～; most ～\n積極的な, 建設的な, 前向きの, 楽観的な態度、行動\n\n事が良い, 好ましい; 見込みのある, 有望な\n\n有益な, 役立つ, ためになる; 教育的な, 善行を促す\n\n 確信して, 自信のある \n\n反応、批評が肯定的な, 好意的な\n\n陽性の",
                       @"動詞～es/-ɪz/; ～ed/-t/; ～ing\n他動詞\n罰する, 懲らしめる; ~で罰する\n\n人、犯罪に罰を科す",
                       @"動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n~を代表する; 代理をする ; 選挙区党の選出議員である; 利益を代表する; ~の考えを代弁する\n\n出席[参加]している; 見受けられる\n\n~の一例である, 好例[典型]である\n\n物、記号が物、事を表す, 象徴する, ~の印である\n\n絵、像、音楽が~を描く, 表現する; ~しているのを描く",
                       @"動詞～s/-s/; shook/ʃʊk/; ～n/-(ə)n/; shaking\n他動詞\n~を振る, 揺さぶる; ~を揺り動かして~にする\n\n物を振り払う, 揺り落とす ;物を振りかける \n\n拳、指を振る\n\n動揺させる, 落ち着かせない; 動揺する\n\n確信、信念をぐらつかせる, 心を乱す\n\n自動詞\n物、地面が揺れる, 震動する\n\n人、体の一部、声が震える\n\n名詞 複～s/-s/\n振ること, 調味料のひと振り分; 握手\n\n震え; 悪寒",
                       @"動詞～s/-dz/; ～; ～ing\n他動詞\n物を広げる, 並べる\n\n手、足を大きく広げる, 鳥、虫が翼、羽を広げる\n\n病気、感情を蔓延[伝染]させる; 問題、影響を広める, 拡大させる; 炎、ガス、液体を広げる, 拡散させる\n\nうわさ、知識を広める, 吹聴する; ~を普及させる\n\nバター、塗料を塗る, つける; パン、壁につける\n\n支払い、授業を行う, 引き延ばす\n\n仕事、責任を分担する, 分散させる; 財産を分配する\n\n自動詞\n病気、感情が蔓延する, 広がる, 問題、影響が及ぶ, 拡大する ; うわさが広まる, 知識が普及する, 伝わる ; ~が分布する\n\nバターが塗れる, 広がる, 伸びる; 塗る\n\n雲、野原が覆う\n\n名詞 複～s/-dz/\n人の増加, 増大; 普及\n\n土地の広がり\n\n幅広い[さまざまな]人、考え、興味; 範囲, 幅",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n自動詞\nぶらぶら歩く, 散歩する; さまよう, 放浪する\n\n他動詞\n~をぶらつく, 散歩する\n\n名詞\nぶらぶら歩き, 散歩",
                       @"名詞 複～s/-ɪz/\n村, 村落 \n\n村の\n\n村人たち",
                       
                       @"形容詞more ～; most ～\n~に気づいている, ~を知っている, 認識[意識, 自覚]している \n\n人が意識の高い, 知識[認識]のある",
                       @"副詞\nまずく, へたに演奏する、話す; 悪くふるまう\n\nとても, どうしても欲しい、必要だ\n\nかなり, ひどく傷つける、悪くなる\n\n不当に, 不利に扱う",
                       ...
                       @"名詞 複～s/-ts/\n意見, 見解; 判断, 判定\n\n判断力, 分別, 見識\n\n判決; 裁判",
                       @"形容詞more ～; most ～\n ありそうな, 起こりそうな; 起こる可能性の高い; ~しそうである; ~する[である]可能性が高い\n\nもっともらしい説明; ありそうな原因、結果; 見込みのある候補者;  適した場所、人\n\nおそらく, たぶん",
                       @"形容詞more ～; most ～\n標準の, 平均の, 普通の\n\n正常な, 標準的な",
                       ...
                       @"動詞\n自動詞\n居住する; 駐在する\n\n性質がある, 備わっている",
                       @"名詞 複～s/-ts/\n結果, 成り行き, 結末\n\n結果; 計算の結果, 答え\n\n業績\n\n動詞～s/-ts/; ～ed/-ɪd/; ～ing\n自動詞\n~という結果に終わる, ~に帰着する\n\n結果として起こる, 起因する",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n自動詞\n~が転がる, 転がって進む\n\n~が転がる, 転げ回る\n\n~が進む, 動く, 走る; 車で行く\n\n波が押し寄せる, うねる; 雲が流れる, 漂う; 地面がなだらかに起伏する\n\n船、飛行機が揺れる, 横揺れする\n\nふらふら歩く, 千鳥足で進む\n\n太鼓、雷がゴロゴロ鳴る, 低い音が長く続く\n\n動き出す, 始まる, 始める\n\n他動詞\n~を転がす, 転がして運ぶ\n\n紙、布を丸める, 巻く\n\n~を丸めて[巻いて]円筒形、球形にする\n\n生地をのばす, 道をならす; ~をのばして[ならして]~にする\n\n車輪付きの物を動かす, 進ませる, 走らせる\n\n名詞 複～s/-z/\n1巻きのフィルム、紙、テープ、紙幣\n\n回転, 転がす動き, 転がり; 回転させること\n\n低く続く轟音, とどろき; 朗々とした調子; さえずり",
                       @"接続詞\n~以来(現在までの間ずっと), ~から, ~以降; ~以来\n\n~して以来ある期間になる; ~して以来ある期間になっていた\n\n~なので, だから, である以上\n\n~なので言うが",
                       @"形容詞more ～; most ～\n目に見える;見える\n\nテレビ、新聞によく登場する; 人目につく",
                       @"形容詞～er; ～est\n野生の, 自然の状態[環境]で育つ, 人の手のかかっていない動植物\n\n未開の; 自然のままの; 荒涼とした; 人の住んでない土地\n\n人、目つきが狂気じみた; 激情した ; 行為が熱狂的な, 猛烈な\n\n乱暴な, 荒々しい, 手のつけようのない; 放埓とした\n\n見当違いの, 突拍子もない, でたらめな考え、計画; 的をそれた投球; 派手な, 奇抜な\n\n夢中に思って, 気に入って  ; たまらなくて\n\n荒れた, 激しい天候、海; 動乱の時勢\n\n副詞\n乱暴に",*/
                      nil];
        ...
        reibunSound = [NSArray arrayWithObjects:
                       @"Don't be afraid.     Are you afraid of snakes?     I didn't mention it because I was afraid of upsetting him.",
                       @"We agreed to leave at once.     I, for my part, totally agree with you.",
                       ...
                       @"There are tea leaves in the bottom of my cup.     He was always bottom of the class in maths.     Put your books on the bottom shelf.",
                       ...
                       @"I'll be back in a moment.     Would you take a seat for a moment?     The big moment has come at last!",
                       @"He was pleased with their warm welcome.",
                       @"I promise never to reveal his secret.     Once he made a promise, he would stick to it.     I have committed myself and must keep my promise.",
    ...
    if ([wordNo isEqualToString:@"6"]) {
        ...
        changeHatuonLabel = [NSMutableArray arrayWithObjects:
                             ...
                             /*@"əláʊ", @"ənáʊns", @"bɪsáɪd, bə-", @"tʃǽlɪn(d)ʒ", @"kleɪm", @"kəndɪ́ʃ(ə)n",
                              @"kəntrɪ́bjət|-bjuːt, kɔ́ntrɪbjuːt", @"dɪ́fr(ə)ns", @"dɪváɪd", @"ékspəːrt",
                              @"féɪməs", @"fɔːrs", @"hɑːrm", @"leɪ", @"piːs", @"prɪns", @"prətékt, ｟米｠proʊ-",
                              @"sens", @"sʌ́d(ə)n", @"ðéərfɔ̀ːr", @"əksépt, æk-", @"əréɪn(d)ʒ", @"əténd",
                              @"bǽləns", @"kɑ́ntræst|kɔ́ntrɑːst", @"ɪnkə́ːrɪdʒ|-kʌ́r-",
                              @"fəmɪ́ljər|-iə", @"ɡræb", @"hæŋ", @"hjuːdʒ", @"nésəsèri, nésəs(ə)ri", @"pǽtərn",
                              @"prəpóʊz", @"pə́ːrpəs", @"rɪlíːs", @"rɪkwáɪər", @"sɪ́ŋɡ(ə)l", @"səksés", @"teər",
                              @"θíːəri|θɪ́ə-", @"əɡénst, əɡéɪnst", @"biːtʃ", @"dǽmɪdʒ", @"dɪskʌ́vər", @"ɪmóʊʃ(ə)n",
                              @"fɪks", @"fræŋk", @"aɪdéntəfàɪ", @"áɪlənd", @"óʊʃ(ə)n", @"pərhǽps",
                              @"pléz(ə)nt", @"prɪvént", @"rɑk|rɔk", @"seɪv", @"step", @"stɪl", @"teɪst",
                              @"θroʊ", @"weɪv", @"bénɪfɪt", @"sə́ːrt(ə)n", @"tʃæns|tʃɑːns", @"ɪfékt", @"ɪsénʃ(ə)l, es-",
                              @"fɑːr", @"fóʊkəs", @"fʌ́ŋ(k)ʃ(ə)n", @"ɡræs|ɡrɑːs", @"ɡɑːrd", @"ɪ́mɪdʒ", @"ɪmíːdiət, -dʒət",
                              @"práɪmèri|-m(ə)ri", @"praʊd", @"rɪméɪn", @"rest", @"sépərèɪt", @"saɪt", @"teɪl",
                              @"trʌ́b(ə)l",*/ nil];
        ...
        changeText = [NSMutableArray arrayWithObjects:
                      ...
                      /*
                       ...
                       @"前置詞\n~のそばに, ~の近くに\n\n~に比べると\n\n~とは無関係で, 要点をはずれて",
                       @"名詞 複～s/-ɪz/\n課題, 意欲をそそるもの ; 難問, 難題; 意欲, やりがい\n\n異議, 抗議, 説明要求\n\n挑戦 ;申し込み\n\n動詞～s/-ɪz/; ～d/-d/; -lenging\n異議を唱える, ~を疑問視する; 異議を唱える ; ~に異議を唱える\n\n挑戦する, 競う; 挑む[言う]  ; 挑む \n\n~の能力を試す, その気にさせる; 刺激する",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n他動詞\n~を主張する; ~だと主張する, 断言する; ~と主張する\n\n要求する, ~の所有権[権利]を主張する; 賠償を請求する \n\n物、事が関心を呼ぶ\n\n自動詞\n支払い請求をする\n\n名詞～s/-z/\n主張, 断言\n\n権利の主張, 資格; 請求権\n\n要求, 請求 ;請求(金)",
                       @"名詞 複～s/-z/\n状態; 体調, 調子; コンディション;健康状態\n\n状況, 事情, 環境; 気象条件\n\n条件; 必要条件\n\n動詞\n他動詞\n~が慣れている, 訓練されている, 条件づけられている",
                       @"動詞～s/-ts/; ～d/-ɪd/; -uting\n他動詞\n~を提供する, 与える\n\n~に投稿する, 寄稿する\n\n自動詞\n寄与する, 貢献する; 寄付する\n\n~の一因となる, 一助となる \n\n投稿[寄稿]する",
                       @"名詞 複～s/-ɪz/\n違い, 相違; 区別; 変化\n\n数量の差, 差異; 差額\n\n意見の不一致[相違], 不和, 紛争\n\nmake a difference\n重要である; 影響が出る; 違いが生じる; <否定文で>重要でない; 影響が出ない; 違いが生じない",
                       @"動詞～s/-dz/; ～d/-ɪd/; dividing\n他動詞\n~を分ける; ~を分割して~にする\n\n道路、川、境界線が場所、地域を隔てる, 分離する\n\n~を分配する, 分ける ;時間を振り分ける \n\n数字を割る, 割り算する ; 数字で割る\n\n~を分裂させる; ~が分裂[対立]している\n\n自動詞\n~が分かれる, 分割する ; 道路、川が分岐する;細胞が分裂する\n\n割り算をする;割る ; 数が 割り切れる ; 割り切る",
                       @"名詞 複～s/-ts/\n 熟練者, 専門家, 達人, 玄人\n\n形容詞more ～; most ～\n  熟達した, 巧みな, うまい; 専門的知識のある ",
                       @"形容詞more ～; most ～\n人、物が有名な, 著名な\n\nうわさでは知っている, 例の",
                       @"名詞 複～s/-ɪz/\n力, 強さ; 威力; 自然の力\n\n影響力を持つ人[物], 支配力\n\n説得力, 効果; 意味\n\n軍隊; 部隊; 陸海空軍; 軍事力, 軍事行動\n\n他動詞\n~に無理やり~させる; ~することを強いる\n\n決定、考えを押しつける\n\n物を押し込む, 押し進める ; 力ずくで物を取る\n\nほほえみを無理に作る, 声を無理に出す",
                       @"名詞\n害, 損害, 危害\n\n悪意, 悪気\n\n不都合, 良くない面, さしつかえ\n\n動詞～s/-z/; ～ed/-d/; ～ing\n他動詞\n~を傷つける, 害する, 痛める",
                       @"動詞～s/-z/; laid/leɪd/; ～ing\n他動詞\n体の一部を置く, 当てる\n\n横に寝かす; 死体を横たえる\n\n物を置く; むちを振り下ろす\n\n物を敷く, 広げる, 固定する; ~を塗る; れんがを積む, 並べる; 鉄道、ケーブルを敷設する\n\n~を~で覆う; ~を並べる[敷く, 塗る]\n\n卵を産む\n\n計画、基盤を作る, 立てる, 築く\n\n企みを立てる; わなをしかける\n\n力点、信頼を置く\n\n~を~にする",
                       @"名詞\n平和, 政治的、社会的安定; 平和な状態[期間]\n\n和平, 和睦; 講和(条約)\n\n 静けさ, 静寂; 沈黙\n\n(心の)安定, 平穏, 安らぎ, 安楽",
                       @"名詞 複～s/-ɪz/\n王子, 皇子, 親王\n\n君主, 公",
                       @"動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n~を保護する\n\n~を守る, 保護する, かばう\n\n~させないようにする\n\n自動詞\n保護機能がある, 防ぐ ;保険、契約が 補償をする",
                       @"名詞 複～s/-ɪz/\n分別のあること, 思慮, 良識 ; 判断力\n\n漠然とした感覚, 感じ; 意識, 心持ち, 気持ち\n\n感じる[知る, わかる, 判別する]力, 心, 感覚, センス\n\n意識; 正気, 本性, 本心\n\n価値, 意義, 意味; 理由, 道理\n\n動詞\n事に感づく, 気づく; ~ということを感づく; ~が~する[~している]のを感づく\n\n機械が事を感知[探知]する; ~かを感知する.",
                       @"形容詞more ～; most ～\n突然の, 急な, 不意の, 思いがけない, 唐突な",
                       @"副詞\nそれゆえに, それで, したがって ",
                       
                       @"動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n~を受け取る; 申し込み、招待、好意を受諾する, ~に応じる\n\n~を受け入れる\n\n考え、意見、説明を正しい[妥当]とみなす; ~を真実、事実と認める; ~ということを認める\n\n不本意な事態を甘受する, 容認する; ~にやむなく従う; ~を~として受け入れる; ~ということを受け入れる\n\n責任、責めを負う, 引き受ける\n\n店、機械が小切手、クレジットカードを受け付ける; 手形を受け取る\n\n~を有効な物として認める, 採用する \n\n社会、クラブが人を迎え入れる ; 学校、団体が~の入学[入会]を認める",
                       @"動詞～s/-ɪz/; ～d/-d/; arranging\n他動詞\n~の手はずを整える, 計画をする, 準備をする; ~ということを取り決める, ~の手はずを整える\n\n~を手配する, 用意する\n\n~をきちんと並べる, 配列する; 整える,整頓する",
                       @"動詞～s/-dz/; ～ed/-ɪd/; ～ing\n他動詞\n会議、儀式、裁判に出席する\n\n患者を診る, 看病[世話]する; 人に付き添う, 随行する\n\n自動詞\n仕事、問題を扱う, 処理する\n\n~に注意を払う; ~を注意して聞く",
                       @"名詞 複～s/-ɪz/\n均衡, バランス, 釣り合い; 均衡のとれた状態;平衡感覚; 平静, 落ち着き \n\n大勢, 大半\n\n預金残高;残金, 差額\n\n残り, 余り\n\n均衡をとるもの, 相殺するもの\n\n動詞～s/-ɪz/; ～d/-t/; -ancing\n他動詞\n~のバランスをとる[保つ]\n\n~の両立を図る, 釣り合いをとる\n\n~の収支を合わせる; ~を収入内におさめる\n\n自動詞\n人、物がバランスをとる[保つ]",
                       @"名詞 複～s/-ts/\n対照, 対比;差異, 相違 \n\n 対照的な人[物, 事]\n\nコントラスト; 対比\n\n~と比べて, 対照的に\n\n動詞～s/-ts/; ～ed/-ɪd/; ～ing\nkəntrǽst|-trɑ́ːst\n自動詞\n物、事が対照をなす, 相違が際だつ\n\n他動詞\n人が2つの物、人、意見を対比[比較]する, 対照させる; ~と~を対比する",
                       ...
                       @"動詞～s/-z/; hung/hʌŋ/\n他動詞\n帽子を掛ける, つるす, つり下げる\n\n絵を掛ける ; 壁紙を貼る; 作品を展示する\n\n部屋、壁が飾られている\n\n人を絞首刑にする ; 首をつる\n\n頭をたれる, うなだれる; 舌をたらす\n\n自動詞\n物がつり下がる, ぶら下がる, ぶら下がっている\n\n衣服、首、髪がたれる, たれ下がる; 掛かっている, 下がっている \n\nたれ下がって~になっている; ~に下がっている\n\n絵、鏡が 掛かっている, 陳列されている ;作品が展示される\n\n煙、霧、においが宙に浮く, 漂う; 鳥が宙を舞う; 月が空に懸かる \n\nもたれかかる, 身を乗り出す, 突き出ている\n\n名詞\n掛かり[垂れ]方[ぐあい]\n\n扱い方, 使いこなすこつ; 大意, 趣旨",
                       @"形容詞～r; ～st\n巨大な; 莫大な, 大変な; でっかい, 大した",
                       @"形容詞more ～; most ～\n必要な, 不可欠な\n\n~することが必要だ\n\n~をする必要がある\n\n必然的な, 必然的に生じる\n\n名詞 複-ies/-z/\n生活必需品, 必要な物",
                       @"名詞 複～s/-z/\n様式, 形式, パターン ;型\n\n模様, デザイン;形式\n\n手本, 模範\n\n動詞\n他動詞\n~の型に倣って作られる",
                       @"動詞～s/-ɪz/; ～d/-d/; -posing\n他動詞\n計画を提案する; 動議を提出する; ~しようと提案する\n\n指名する, 推薦する\n\n理論、説明を提案する; ~であると提唱する\n\n~をもくろむ; ~するつもりである\n\n自動詞\n結婚を申し込む",
                       @"名詞 複～s/-ɪz/\n 目的, 意図, ねらい ; 理由, 趣旨\n\n生きがい",
                       @"動詞～s/-ɪz/; ～d/-t/; releasing\n他動詞\n~を解き放す, 自由にする;  ~を救出する\n\n握っているものを放す; 爆弾を投下する; ミサイルを発射する\n\nニュース、情報を公表[公開]する\n\n固定された装置をはずす, 解く\n\n感情を発散する, 表に出す; 能力を発揮する\n\n化学物質、熱を放出する, 放つ\n\n~を解く, 免除する\n\n名詞 複～s/-ɪz/\n 解放, 釈放, 退院; 救出 ; 解除; 解除装置\n\n緊張、苦痛からの解放, 息抜き; 発散, 解放\n\n発売, リリース; 新譜; 映画の封切り; 封切り映画\n\n公開, 公表\n\n化学、物質ガスの放出, 流出",
                       @"動詞～s/-z/; ～d/-d/; requiring/-wáɪ(ə)rɪŋ/\n他動詞\n~を必要とする; ~を必要とする; ~することが必要である\n\n~するように要求する, 命令する; ~を要求する",
                       @"形容詞\nたった1つの; <否定構文で>ただの1つ[1人]も(~でない)\n\n個々の, 1つ1つの, 各々の; まさに, 唯一の\n\n人が独身の; ひとり身の\n\nベッドが1人用の; 部屋が1人専用の, シングルの\n\n片方だけの;切符が片道の; 花弁が一重の, ゲームがシングル試合の\n\n名詞\n独身者\n\n 片道切符",
                       @"名詞 複～es/-ɪz/\n成功; 出世; 合格\n\nうまくいった事[物]; 大当たり\n\n成功した人",
                       @"動詞～s/-z/; tore/tɔːr/; torn/tɔːrn/;～ing/téərɪŋ/\n他動詞\n~を引き裂く, 破る; ~を引き裂いて~にする; 穴を開ける\n\n~を引き裂いて[引きちぎって]~にする\n\n~を引きはがす, 破り取る, 引き離す\n\n分裂する, ばらばらになる  ; 人が心を引き裂かれる, 傷つく\n\n自動詞\n紙が裂ける, 破れる; 穴が開く\n\n引っぱる, 引き裂こうとする\n\n大急ぎで動く, 疾走[突進]する",
                       @"名詞 複-ries/-z/\n学説, ~論[説]\n\n(学問的な)原理; (一般的な)理論, 理屈\n\n推測, 憶測; 個人的見解",
                       
                       @"前置詞\n意見、主義、行為に反対して\n\n意志、希望に反して\n\n法、規則に違反して\n\n人、理論に不利で\n\n~によりかかって, もたれて\n\n人、物に当たって, 触って\n\n流れ、風に逆らって\n\n物、風景を背にして, ~に映えて\n\n事柄と関連して; 事件、事情が背景となって; 預金、支払いと引換えに\n\n数値と比べて; 資料と照らし合わせて\n\n病気、事故に備えて; ~を防いで, ~に対して\n\n~を防いで",
                       @"名詞 複～es/-əz/\n浜辺, 海岸, 湖岸; 砂浜, なぎさ",
                       @"名詞 複～s/-ɪz/\n損害, 損傷, 被害\n\n損害賠償金\n\n動詞～s/-ɪz/; ～d/-d/; -aging\n他動詞\n~に損害[損傷]を与える; 健康を損なう",
                       @"動詞～s/-z/; ～ed/-d/; ～ing/-kʌ́v(ə)rɪŋ/\n他動詞\n~を発見する, 見つける; ~に気付く\n\n~ということを知る[悟る]; ~かどうかわかる\n\n~しているのを見つける; ~であるとわかる\n\n楽しみ、趣味を見いだす",
                       @"名詞 複～s/-z/\n感情, 気持ち; 感動, 感激 ; 情動",
                       @"動詞～es/-ɪz/; ～ed/-t/; ～ing\n他動詞\n物を固定する, 取り付ける\n\n事を留める ; 習慣、制度を定着させる\n\n食事、飲み物を作る, 用意する\n\n物を修理する, 直す; 繕う;医者が体の部位を治療する\n\n問題を改善する, 解決する\n\n時間、場所、日時を決める; 特定する;価格を設定する, 固定する\n\n試合、選挙を不正に仕組む; 人を買収する; 価格を不正に操作する\n\n事の手はずを整える;化粧、髪、服を整える\n\n視線、注意が引きつけられる, 注がれる\n\n自動詞\n視線が向く, じっと見つめる\n\n~するつもりである\n\nfix ~ up\n取引の手はずを整える; ~するよう手配する\n\n提供[手配]する\n\n名詞\n困った状況, 苦境\n\n解決策\n\n航空機、船の位置確認; 理解",
                       @"形容詞～er; ～est/more ～; most ～\n率直な, ストレートな, 包み隠さない\n\n公然の, 明らかな",
                       @"動詞-fies/-z/; -fied/-d/; ～ing\n他動詞\n同一人[物]であると確認する, ~の身元を確認する, ~を同定する; ~であるとわかる \n\n問題、物事の本質を特定する, 明確にする; ~か特定する\n\n物、事を同一視する, 関連づけて考える\n\n関係する, 共鳴する\n\n自動詞\n共鳴[共感]する, 一体感を持つ",
                       @"名詞 複～s/-dz/\n島; ~島;島の\n\n島に似たもの; 趣が周辺と異なる所",
                       @"名詞 複～s/-z/\n海\n\n海洋, 大洋; ~洋, ~海\n\n膨大な量[広がり]",
                       ...
                       @"動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n~するのを妨げる\n\n~を防ぐ, 中止させる; 人をじゃまする\n\n病気、事故を予防する, 防止する",
                       @"名詞 複～s/-s/\n岩, 岩盤, 岩壁, 岩山\n\n岩石, 岩;石, 小石\n\n暗礁, 岩礁",
                       @"動詞～s/-z/; ～d/-d/; saving\n他動詞\n~を救う, 救助[救出]する\n\n金を蓄える, 貯蓄する;物、力を取っておく\n\n人が金、時間、エネルギーを節約する ; ~の節約になる \n\n不愉快[不便]なことをしなくて済むようにする, ~のむだを省く; ~の手間を省く;~することを不要にする\n\n~を確保する\n\n自動詞\n貯金する",
                       @"名詞 複～s/-s/\n歩み, ~歩; 歩幅\n\n問題解決、成功への一歩, 段階, 手段\n\n屋外の階段 \n\n階級, 職階\n\n歩調; 足取り, 歩くしぐさ; ステップ\n\n脚立\n\n動詞～s/-s/; ～ped/-t/; ～ping\n自動詞\n一歩進む, 一歩分動く\n\n短い距離を歩く",
                       @"副詞\nまだ, なお, 今でも, 依然として; 今後も\n\nそれでも, それにもかかわらず\n\nそうだとしても\n\nさらに,いっそう\n\n形容詞～er; ～est\n静止した, 動かない, じっとした\n\n場所がしんとした, 音[声]がしない",
                       @"名詞 複～s/-ts/\n味, 風味\n\nセンス, 鑑賞[判断]力\n\n好み, 嗜好\n\n少量, 一口; 味見\n\n経験; 一端\n\n動詞～s/-ts/; ～d/-ɪd/; tasting\n自動詞\n~な味がする\n\n~の味がする\n\n他動詞\n~を味わう; 味見する; 少し食べる[飲む]\n\n~の味がわかる, 味を感じる\n\n<否定文で>食物を口にする",
                       @"動詞～s/-z/; threw/θruː/; thrown/θroʊn/; ～ing\n他動詞\n物を投げる\n\n~を無造作に置く, ほうり出す\n\nミサイルを発射する, 放つ ;水をかける\n\n~を押す, 動かす; 勢いよく押すして~を~にする ; 相手を投げ倒す; 振り落とされる\n\n手足、頭を突然動かす; 身を投げ出す\n\n突然陥らせる, 投げ込む\n\n光、影を浴びせる, 落とす\n\n視線、ほほえみを投げかける, 向ける\n\n疑惑を投げかける\n\n質問、意見を浴びせる\n\n~に投じる, 没頭する ; 活力、金を仕事、活動に注ぎ込む\n\n突然の発言、行動が人を混乱させる, ろうばいさせる\n\nパーティを行う\n\n試合にわざと負ける\n\nさいころを振る;数を出す\n\n自動詞\n人が投げる, ほうる; 振る\n\n名詞 複～s/-z/\n投げること;振ること",
                       @"名詞 複～s/-z/\n波\n\n振ること; 振って行う合図\n\n急増, 頻発; 高まり;波, 傾向\n\n波, 殺到\n\n動詞～s/-z/; ～d/-d/; waving\n自動詞\n手を振る\n\n旗、枝が揺れる, 揺らめく\n\n他動詞\n手、手に持った物を振る; ~を振り回す\n\n~に手を振って合図する; 手を振って指し示す\n\n手を振ってあいさつをする",
                       ...
                       @"名詞 複～s/-ts/\n 影響, 効果; 効用, 効能, ききめ\n\n効果, 装置; エフェクト; 印象, 雰囲気\n\n動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n結果をもたらす; 目的を成就する",
                       @"形容詞more ～; most ～\n必要不可欠な, きわめて重要な, 必須の\n\n本質的な, 根本的な, 基本的な特徴、違い\n\n名詞 複～s/-z/\n必要不可欠な[絶対必要な]物\n\n最重要事項, 要点",
                       @"副詞\n<否定文、疑問文で>(場所、建物から)遠く, ずっと, 遠くへ[に], はるかに\n\n(時間が現在から) 遠く, はるかに\n\nはるかに, 大いに, ずっと\n\nある場所、程度まで\n\n形容詞farther; farthest/further; furthest 遠い方の, 向こうの; 最も遠い地点の; 奥の",
                       @"動詞～es, ～ed/-t/, ～ing\n他動詞\n注意意識を集中させる\n\nカメラ、目の焦点[ピント]を合わせる\n\n自動詞\n焦点[ピント]が合う, 焦点をしぼる; ~が集中する, 関心が向く\n\n名詞 複～es/-ɪz/, foci/-saɪ/\n中心, 焦点, 的\n\n重点, 力点; 目的, 意図\n\nピント",
                       @"名詞 複～s/-z/\n機能, 働き, 作用; 職務, 任務, 役割; 機能すること, 働き方\n\n行事, 催し, 儀式, 祭典; 夕食会, パーティ\n\n動詞～s/-z/; ～ed/-d/; ～ing\n自動詞\n機械が機能する, 働く, 動く; 人が正常に活動する\n\n機能[役割]を果たす ",
                       @"名詞 複～es/-ɪz/\n草, 牧草; 芝\n\n草地, 牧草地;芝生, 芝地",
                       @"名詞 複～s/-dz/\n警備員, 守衛, 監視員, ガードマン; 護衛; 警備隊, 守備[護衛]隊\n\n防護器具, 安全[保護]装置\n\n防護, 防御, 防衛; 警戒, 監視, 警備\n\n警戒心, 用心, 不信感\n\n動詞～s/-dz/; ～ed/-ɪd/; ～ing\n他動詞\n~を守る, 保護する, 警備する\n\n~を監視する; 囚人を見張る\n\n秘密、情報、利得を守る, 守秘する, 漏らさない; 感情を表に出さない; 言動を慎む, 控えめにする\n\n自動詞\n用心する, 警戒する; 発生を防ぐ, 予防する",
                       @"名詞 複～s/-ɪz/\n印象, イメージ\n\n像; 映像, 画像\n\n生き写しの[そっくりな]人[物]\n\n象徴, 典型",
                       @"形容詞\n即座の, 即刻の, 即時の反応、行動、効果\n\n目下の, 目前の, 当面の, 急を要する必要な事、問題\n\nすぐ続いた; いちばん近い関係\n\n直接に接している, 隣の; じかの, 直接の原因",
                       @"形容詞\n最も重要な, 主要な; 第1の\n\n初等の, 初級の学校、教育\n\n最初の, 一次の, 初期の\n\n名詞 複-ries/-z/\n予備選挙 \n\n原色 ",
                       @"形容詞～er; ～est\n誇りに思う, 誇るべき; うれしい, 喜ばしい\n\n自慢げな, 得意になっている; 高慢な, 横柄な",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n自動詞\n~が~のままである, 相変わらず~だ\n\n~にとどまる, 居残る\n\n~が残っている\n\nこれから~されなければならない, まだ~されないままだ\n\n名詞\n残り, 残り物",
                       @"名詞 複～s/-ts/\n休息, 休憩; 休養; 睡眠\n\n解放 ; 安らぎ; 死, 永眠\n\n支え, 台\n\n動詞～s/-ts/; ～ed/-ɪd/; ～ing\n自動詞\n人が休息する, 休む; 眠る\n\n物、体の一部が ある, 載っている ; もたれている\n\n見解、将来がかかっている, 基づく;依拠する, 当てにする\n\n決定、責任がかかっている, 次第である\n\n物が静止[停止]する; 問題、議論がそのままにされる\n\n永眠する\n\n他動詞\n体の一部を休ませる, 休息[休養]させる\n\n腕、頭を置く, 載せる ;~をよりかからせる \n\n名詞\n残り\n\nそのほかの~\n\n動詞\n自動詞\n~のままである, 依然として~である",
                       @"動詞～s/-ts/; ～d/-ɪd/; -rating\n他動詞\n物、空間が2つのものを隔てる; ~を分ける; 得点がチームの勝敗を決める\n\n~を区分する, 分け隔てる, 仕切る\n\n引き離す, 別居させる, 離れ離れにさせる ; 仲たがいさせる\n\n考えを区別[識別]する; 特性が物を区別する\n\n~をより分ける; 雑物を取り除く ; 成分の一部を分離する\n\n自動詞\n別れる, 離れる, 離脱する ; 集団が離散[散会]する;分かれる\n\n夫婦が別居生活する; 子が【親から】別れて暮らす\n\nボタンがとれる, はがれる \n\n成分が 分離する\n\n形容詞\n物、場所、建物が離れた\n\n別々の, 個々の行動、理念; 単独の; 異なる",
                       @"名詞 複～s/-ts/\n土地, 敷地\n\n(重大な出来事が起こった)場所, 跡地\n\n(ウェブ)サイト\n\n動詞\n他動詞\n配置される, 設置される, 用地[場所]が決まる",
                       @"名詞 複～s/-z/\n尾, しっぽ\n\n尾に似たもの, たれているもの\n\n後部; 最後; 末尾",
    ...
    if ([wordNo isEqualToString:@"11"]) {
        ...
        changeHatuonLabel = [NSMutableArray arrayWithObjects:
                             ...
                             /*@"əlóʊn", @"əpɑ́ːrtmənt", @"ɑ́ːrtɪk(ə)l", @"ɑ́ːrtəst", @"ǽtətjùːd", @"kəmpéər", @"dʒʌdʒ",
                              @"mǽɡəzìːn", @"mətɪ́əriəl", @"miːl", @"méθəd", @"néɪbər", @"prəféʃ(ə)n(ə)l", @"prɑ́fət|prɔ́f-",
                              @"kwɑ́ləti|kwɔ́l-", @"ʃeɪp", @"speɪs", @"steər", @"sɪ́mb(ə)l", @"θɪn", @"blʌd", @"bəːrn",
                              @"sel", @"kəntéɪn", @"kərékt", @"krɑp|krɔp", @"dɪmǽnd|-mɑ́ːnd", @"íːkw(ə)l", @"fiːd",
                              @"hoʊl", @"ɪnkríːs", @"lɔːrd", @"oʊ", @"pəzɪ́ʃ(ə)n", @"reɪz", @"rɪspɑ́nsəb(ə)l|-spɔ́n-",
                              @"saɪt", @"spɑt|spɔt", @"strʌ́ktʃər", @"hoʊl",@"koʊtʃ",@"kəntróʊl",@"dɪskrɪ́pʃ(ə)n",@"dərékt|daɪ-",
                              @"ɪɡzǽm", @"ɪɡzǽmp(ə)l|-zɑ́ːm-", @"lɪ́mət", @"lóʊk(ə)l", @"mǽdʒɪk(ə)l", @"meɪl", @"nɑ́v(ə)l|nɔ́v-",
                              @"áʊtlàɪn", @"póʊət", @"prɪnt", @"siːn", @"ʃiːt", @"sɪ́li", @"stɔːr", @"sʌ́fər", @"teknɑ́lədʒi|-nɔ́l-",
                              @"əkrɔ́ːs|əkrɔ́s", @"briːð", @"kæ̀rəktərɪ́stɪk", @"kənsjúːm", @"ɪksáɪt, ek-", @"ɪkstríːm, eks-",
                              @"fɪər", @"fɔ́ːrtʃ(ə)nət", @"hǽp(ə)n", @"leŋ(k)θ", @"mɪstéɪk", @"əbzə́ːrv", @"ɑ̀pərtjúːnəti|ɔ̀p-",
                              @"praɪz", @"reɪs", @"ríːəlàɪz|rɪ́əl-", @"rɪspɑ́nd|-spɔ́nd", @"rɪsk", @"wʌ́ndər", @"jet",*/ nil];
        ...
        changeText = [NSMutableArray arrayWithObjects:
                      ...
                      /*
                       ...
                       @"名詞 複～s/-ɪz/\n裁判官, 判事; 治安判事\n\n審判(員), 審査員 \n\n適切な判断力のある人; 目きき, 鑑定家\n\n動詞～s/-ɪz/; ～d/-d/; judging\n他動詞\nを判断する, 評価する ; ~であると[~だと, ~かを]判断する, 見極める; 人を批判する\n\nを推定する, 見積もる; ~であると[~だと, ~かを]推定する\n\nを裁判[審理]する, ~に判決を下す\n\n自動詞\n判断[評価]する",
                       @"名詞 複～s/-z/\n雑誌, 定期刊行物\n\n雑誌の",
                       @"名詞 複～s/-z/\n生地, 服地\n\n原料, 材料, 素材\n\n用具, 道具\n\n題材, 情報, 考え; 資料\n\n人材, 人物\n\n曲, 出し物\n\n形容詞\n物質的な; 肉\n\n物質の; 有形の\n\n証拠、情報が重要な, 重大な",
                       @"名詞 複～s/-z/\n食事の時間; 食事量, 1食分",
                       @"名詞 複～s/-dz/\n方法, 方式\n\n秩序, 順序; 筋道; きちょうめんなこと",
                       ...
                       @"名詞 複～s/-ts/\n利益, もうけ, 利潤, 黒字\n\n利益, 得\n\n動詞～s/-ts/; ～ed/-ɪd/; ～ing\n自動詞\n利益を得る\n\n得をする; 教訓を得る\n\n他動詞\nの利益になる, 役に立つ",
                       @"名詞 複-ties/-z/\n質, 性質, 品質;特性, 特質, 属性\n\n性格, 性質; 資質, 特徴\n\n高品質, 高水準, 上質, 良質\n\n形容詞\n高品質の",
                       @"名詞 複～s/-s/\n形, 形状; 輪郭;体形, スタイル\n\nおぼろげな姿の物, まぼろし, 幽霊\n\n具体的な形, 実現; 表現\n\n姿, 形\n\n状態, 調子\n\n型, 鋳型\n\n動詞～s/-s/; ～d/-t/; shaping\n他動詞\n思想、計画を形作る, 具体化する ; 考え、態度に影響を与える, ~を方向づける; ~を言い表す\n\nを形作る ; 材料を押して~を作る\n\n物を適合させる, 合わせる\n\n自動詞\n事態が思い通りに進展する; まとまる, 具体化する",
                       @"名詞 複～s/-ɪz/\n場所, スペース, 空間 ; 広々としていること; 空き容量\n\nすきま; 間隔, 距離\n\n場所, 空間; 面積\n\n土地\n\n宇宙空間;宇宙の\n\n空間\n\n期間;間隔; しばらくの間\n\n自由な時間\n\n語[行, 字]間, スペース; 文字の幅\n\n余白; 紙面; コマーシャルの時間\n\n動詞\n他動詞\n物を一定の間隔で置く[並べる]; 事を一定の間隔で行う; ~の語[字, 行]間を空ける",
                       @"名詞 複～s/-z/\n階段\n\n階段の1段",
                       @"名詞 複～s/-z/\n象徴, 表象, シンボル\n\n記号, 符号",
                       @"形容詞～ner; ～nest\n薄い; 紙、布が薄手の\n\nやせて, 手、足まゆが細い, 唇が薄い, 顔がやせ細った\n\n針金、線が細い\n\n液体が薄い, 水っぽい, 酒が弱い\n\n霧煙が薄い; 空気、気体が薄い, 希薄な\n\n群衆がまばらな, 閑散とした\n\n声音がか細い; 色光が弱い\n\n髪が薄い, まばらな; 葉が茂っていない\n\n貿易、経済が不景気の, ふるわない; 中身が乏しい\n\n議論、説明が説得力のない, 内容の薄い; 情報が乏しい\n\n動詞～s; ～ned; ～ning\n自動詞\n群衆、木がまばらになる\n\n髪が薄くなる",
                       
                       @"名詞\n血, 血液\n\n血統, 家系\n\n体液; 樹液\n\n流血, 暴力\n\n血気, 情熱",
                       @"動詞～s/-z/; ～ed/-d/, ～t/-t/; ～ing\n自動詞\n火、ろうそくが燃える; 物が燃えている, 火事である; 燃えて~になる\n\n焦げる; 焦げて~になる\n\n日焼けする\n\nやけどをする ; ~がやけどをつくる\n\n燃料が燃える, 燃焼する\n\n光、灯火が輝く, ともる, 目が光る\n\n体が痛い, ひりひりする; ほてる\n\n顔、ほおが熱くなっている, 紅潮している\n\n他動詞\n~を燃やす, 焼く; 行為、機械が燃料、カロリーを燃やして力[熱, 光]を作る, ~を燃料とする; 火をともす\n\n体の一部をやけどする ; やけどをする\n\nを焦がす, 焦げつかせる; 焼いて[焦がして]~に穴をあける; ~を焼いて[焦がして]~にする\n\n体の一部を日焼けさせる; ~を日焼けさせて~にする\n\n目、のど、切り傷をひどく熱く感じさせる; ひりひりさせる\n\n名詞 複～s/-z/\nやけど, 熱傷 ; 焼け[焦げ]跡 ; 焼き印; 日焼け",
                       @"名詞 複～s/-z/\n細胞\n\n独房, 監房",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n他動詞\n入れ物、場所が物を含む, 入れている; 本、映画が情報、考えを含む, 取り込んでいる; 物質が~を含む; 団体、組織が人数から成っている; 部屋、会場が人数を収容する",
                       @"形容詞more ～; most ～/～er; ～est\n正しい, 誤りのない, 正確な, 本当の\n\nふさわしい, 適切な; 行動、服装が礼儀正しい, 丁寧な\n\n動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\nを訂正する, 直す, 正す; を添削する\n\n人をしかる, 罰する",
                       @"名詞 複～s/-s/\n作物, 農産物\n\n収穫高, 作柄; 生産[産出]高\n\n続出する集団、物; ~の集まり[群れ]\n\n動詞～s/-s/; ～ped/-t/; ～ping\n他動詞\nを短く切る; ~を刈って~にする\n\nを切り落とす;不要な部分を切る\n\n自動詞\n作物ができる, 取れる",
                       @"名詞 複～s/-dz/\n需要\n\n要求, 請求\n\n負担, 差し迫った必要\n\n動詞～s/-dz/; ～ed/-ɪd/; ～ing\n他動詞\n物、事を要求する, 求める, 請求する ; ~することを要求する\n\n~するように要求する\n\n時間、エネルギー、技術を必要とする, 要する\n\n自動詞\n必要とする",
                       @"形容詞more ～; most ～\n等しい, 同じで «to/in»\n\n平等な, 対等の; 均等な, 一様な\n\n能力[力量]がある \n\n互角な,  匹敵する\n\n動詞～s; ～ed; ～ing\n\n他動詞\n~と等しい\n\n~に匹敵する, 並ぶ\n\n名詞\n対等な人[物], 匹敵する人[物]",
                       @"動詞～s/-dz/; fed/fed/; ～ing\n他動詞\nえさをやる; 肥料をやる; 食事を与える\n\n家族を養う\n\n食べ物、えさを与える\n\n機械、容器に(燃料、コインを)提供する, 投入する;コンピュータに(データを)送る\n\n人、メディアに情報、うそを伝える, 吹き込む\n\n感情、欲求をあおる; 虚栄心、罪悪感をより感じさせる; 目、耳を楽しませる\n\n自動詞\nえさを食べる; 乳を飲む\n\n名詞 複～s/-dz/\nえさ, かいば, 飼料",
                       @"名詞 複～s/-z/\n穴; くぼみ; すき間, 破れ目\n\n巣穴, 隠れ家; 独房, 土牢\n\n苦境, 窮地; 地位の空き, 時間のすき間\n\n欠点, 不備, 弱点\n\n他動詞\n船、建物が穴があく",
                       @"動詞～s/-ɪz/; ～d/-t/; increasing\n自動詞\n増える, 増加[増大]する\n\n他動詞\nを増やす, 高める\n\n名詞 複～s/-ɪz/\n 増加, 上昇; 増加量",
                       @"名詞 複～s/-dz/\n高位の貴族\n\n領主, 地主; 荘園主\n\n~長, 長官; ~主教\n\n主, 神; キリスト",
                       @"動詞～s/-z/; ～d/-d/; owing\n借金がある, お金、金額を借りている; ~に金額の借金がある, ~にお金を借りている\n\n恩義[借り]がある ; ~に返すべきものをもらっている; ~を返す[する]義務がある\n\n~のおかげである\n\nある気持ちを抱いている\n\n~する義務がある",
                       @"名詞 複～s/-z/\n位置;所定の位置; 場所\n\n状況、財務状況\n\n姿勢; 向き;方向\n\n態度, 判断, 意見\n\n職, 仕事\n\n地位, 階級, 役職\n\n立場\n\n動詞\n他動詞\n物、人を置く",
                       @"動詞～s/-ɪz/; ～d/-d/; raising\n他動詞\n物、体の一部を上げる\n\n旗を掲げる; 物を立てる, 人を起こす\n\n人が身を起こす, 起き上がる\n\n料金、数値、賃金を上げる, 増やす\n\n質、水準を向上させる, 上げる\n\n子供を育てる, 養育する\n\n家畜を飼育する; 作物を栽培する\n\n金を募る; 資金を集める\n\n~を提起する; 質問、異議を出す\n\n恐怖、疑惑を引き起こす; 笑みを生じさせる\n\n声を張り上げる; 警報を鳴らす\n\n封鎖、包囲を解く, 解除する\n\n数字を累乗する\n\n水ぶくれを作る; パンをふくらませる\n\n名詞\n昇給額, 賃上げ",
                       @"形容詞more ～; most ～\n~に責任[責務]がある; 責任を負うべき\n\n~が原因である, 招いた\n\n信頼できる, 責任を果たしうる\n\n責任能力が必要な, 責任の重い",
                       @"名詞複～s/-ts/\n視力, 視覚\n\n見る[見える]こと; 一見, 一瞥\n\n視野, 見える範囲, 視界\n\n景色, 光景, 眺め \n\n名所, 見所\n\nねらい, 目標\n\n物笑いの種, ひどいもの\n\n多数[多量]の~",
                       @"名詞複～s/-ts/\n\n場所, 地点\n\n斑点, まだら, ぶち; 染み, 汚点; 水玉模様\n\n発疹;(主に顔の)にきび, 吹き出物\n\n出場, 出演, 出番; スポット広告[CM]\n\n良い、悪い点, 事, 箇所\n\nちょっとした事、物\n\n少量の~\n\n動詞～s/-ts/; ～ted/-ɪd/; ～ting\n他動詞\n~を見つける, 発見する, ~に気づく; ~しているのを見つける; ~ということ[~か]に気づく\n\n~の能力性質を見抜く, 察知する\n\n斑点[しみ]になっている\n\n自動詞\n雨がポツポツ降る\n\n形容詞\n即時支払いの, 現物取引の\n\n報道が現場からの; ニュース、広告が番組の間に挿入される, 臨時の",
                       @"名詞 複～s/-z/\n構造, 仕組み, 構成; 組織, 機構\n\n建造物, 建築物, 構造物",
                       @"形容詞\n全体の事、人、物, 全部の~, まるごとの~\n\n1つ丸ごとの; 丸~の期間, ~中\n\nたいへんな~, ものすごい~, 大事な~\n\n無傷で; 健康で\n\n名詞\n~全体, ~の全部\n\n統一体, 完全体\n\n副詞\nこれまでとの違いを強調してまったく",
                       ...
                       @"名詞 複～s/-z/\n試験, テスト ",
                       @"名詞 複～s/-z/\n例, 実例\n\n模範, 手本; 見本\n\n見せしめ, 戒め",
                       @"名詞 複～s/-ts/\n限度, 上[下]限, 制限\n\n限界\n\n境界, 端\n\n動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n数量を制限する, 抑える;人、事を制限[制約]する ; 自らを~に限定する, 束縛する\n\n特定の場所、集団に限られている, 限定されている",
                       @"形容詞\n地元の; その地方の; 当地の; 地域の\n\n各駅停車の\n\n局地的な; 考え方が狭い, 偏狭な\n\n地元の住民",
                       @"形容詞more ～; most ～\n魅惑的な, 人を魅了する\n\n魔法の; 不思議な",
                       @"名詞 複～s/-z/\n郵便\n\n郵便物, 手紙類\n\n電子メール\n\n動詞～s/-z/; ～ed/-d/; ～ing\n他動詞\nを郵送する, 投函する\n\n~に送る\n\n電子メールで送る",
                       @"名詞 複～s/-z/\n小説",
                       ...
                       @"名詞 複～s/-s/\n特徴, 特色, 特質\n\n形容詞more ～; most ～\n\n特徴[特質]を示す; 特有の[な], 独特の ; ~するのは~の特徴である",
                       ...
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n自動詞\n予期せずに偶然起こる\n\n何かの結果として起こる, 生じる\n\nよくない事が人に起こる, ふりかかる\n\n人、物、事が偶然~する; たまたま~である ",
                       @"名詞 複～s/-s/\n寸法としての長さ, 丈; 縦\n\n時間の長さ, 期間\n\n本、記録の長さ, 全体の分量; 映画、劇の上演時間\n\n時間、寸法が長いこと\n\n全長, 端から端まで\n\n~の長さの\n\n長さ, 端から端までの距離;1馬身\n\n細長いものの1本 ",
                       @"名詞 複～s/-s/\n誤り, 間違い; 誤解, 失策; 愚行 \n\n言葉、数字の間違い, 誤り\n\n動詞～s/-s/; -took/-tʊ́k/; ～n/-téɪk(ə)n/; -taking\n他動詞\n~と誤解する, 間違える, 取り違える; ~かを誤解する\n\n~と間違える",
                       @"動詞～s/-z/; ～d/-d/; observing\n他動詞\n~に気付く, ~が見てわかる ;~しているのを目撃する, のに気付く\n\n~であることに気付く\n\n観察する, 観測する, 見守る, 監視する\n\n法律、契約、習慣を守る\n\n気付いたことを述べる, 陳述する",
                       @"名詞 複-ties/-z/\n 機会, チャンス\n\n就職[出世]の機会[見込み]",
                       @"名詞 複～s/-ɪz/\n 賞, ほうび, 賞品, 景品, 賞金\n\n貴重[すてき]なもの; 努力するに値する物[人], 申し分のない人\n\n形容詞\n懸賞の, 賞として与えられる; 入賞の; 見事な; 模範的な; うってつけの\n\n動詞\n他動詞\n~が高く評価される, 重んじられる",
                       @"名詞 複～s/-ɪz/\n競走, レース\n\n競争, 戦い\n\n競馬, ドッグレース; 競馬場\n\n動詞～s/-ɪz/; ～d/-t/; racing\n\n自動詞\n競走する; 競争する\n\n急いで行く, 疾走する; 思考が駆けめぐる; 事態がある状態に急速に向かう\n\n心臓、脈拍が速まる; 頭が活発に働く\n\n他動詞\n~と競走する\n\n競走させる, 出走させる\n\n~を急いで運ぶ; 車を全速力で走らせる; 議案を急いで通過させる\n\n名詞 複～s/-ɪz/\n人種; 人種の\n\n民族, 種族;民族[種族]の\n\n類, 種族",
                       @"動詞～s/-ɪz/; ～d/-d/; -izing\n他動詞\nを認識する, 悟る; 知る; ~だと気づく\n\nを実現する, 達成する\n\n恐れていたことが起こる, 現実となる\n\n資産を売って現金にする; 利益を得る\n\n金額で売れる; 利益をもたらす",
                       @"動詞～s/-dz/; ～ed/-ɪd/; ～ing\n\n反応する, 応じる, 報いる\n\n答える, 応答[返答]する\n\nよい反応を示す",
                       @"名詞 複～s/-s/\n 恐れ, 危険, リスク\n\n危険因子, 有害なもの\n\n被保険者[物]\n\n動詞\n他動詞\nを危険にさらす;を賭ける \n\nの危機に陥る; ~する恐れがある\n\n~をあえてする, 試みる; あえて~する",
    ...
    if ([wordNo isEqualToString:@"16"]) {
        ...
        changeHatuonLabel = [NSMutableArray arrayWithObjects:
                             ...
                             @"pʌ́blɪʃ", @"θíːətər|θɪ́ətə", @"welθ",/* @"əpríːʃièɪt", @"əvéɪləb(ə)l", @"biːt",
                                                                      @"braɪt", @"séləbrèɪt", @"dɪtə́ːrmɪn", @"dɪ̀səpɪ́ər",
                                                                      @"els", @"feər", @"floʊ", @"fɔ́ːrwərd", @"hɪl", @"lév(ə)l", @"loʊn", @"pʌ́d(ə)l",
                                                                      @"rɪspɑ́ns|-spɔ́ns", @"síːz(ə)n", @"səlúːʃ(ə)n", @"weɪst", @"(h)wéðər", @"ɑ́ːrɡjuː", @"kəmjúːnɪkèɪt",
                                                                      @"kraʊd", @"dɪpénd", @"dɪʃ", @"ém(p)ti", @"ɪɡzǽkt", @"freʃ", @"ɡǽðər",
                                                                      @"ɪ́ndɪkèɪt", @"áɪtəm", @"ɔ́ːfər|ɔ́fə",@"praɪs",@"prɑ́dʌkt, -əkt|prɔ́d-",@"prɑ́pərti|prɔ́p-",@"pə́ːrtʃəs",
                                                                      @"rèkəménd", @"səlékt", @"tuːl", @"triːt",@"əláɪv",@"boʊn",@"bɑ́ðər|bɔ́ðə",@"kǽpt(ə)n|-tɪn",
                                                                      @"kənklúːʒ(ə)n",@"daʊt",@"ɪksplɔ́ːr, eks-",@"fɔ́ːr(ə)n, fɑ́r-|fɔ́r-",@"ɡlæd",@"haʊévər",@"ɪndʒʌ́stɪs",
                                                                      @"ɪ̀ntərnǽʃ(ə)n(ə)l", @"lɔ́ːjər, lɔ́ɪər", @"ménʃ(ə)n", @"pɑ́ləsi|pɔ́l-", @"sóʊʃ(ə)l", @"spiːtʃ",
                                                                      @"stæf|stɑːf", @"tɔːrd|təwɔ́ːd", @"wʊd",
                                                                      @"ətʃíːv", @"ədváɪz", @"ɔː(l)rédi", @"béɪsɪk", @"bɪt", @"kənsɪ́dər",
                                                                      @"dɪstrɔ́ɪ", @"èntərtéɪn", @"ékstrə", @"ɡoʊl", @"laɪ", @"miːt", @"əpɪ́njən",
                                                                      @"ríː(ə)l|rɪ́əl", @"rɪflékt", @"rɪɡɑ́ːrd", @"sə́ːrv", @"védʒ(ə)təb(ə)l", @"wɔːr", @"wəːrθ",*/ nil];
        ...
        changeText = [NSMutableArray arrayWithObjects:
                      ...
                      /*
                       @"動詞～s/-ts/; ～d/-ɪd/; -ating\n他動詞\n状況、問題を正しく理解[認識]する; ~であることを正しく理解する\n\nに感謝する, ~をありがたく思う; ~することをありがたく思う\n\n人、物、事のよさ[素晴らしさ]を認める;評価する\n\nを鑑賞する; 食べ物を味わう, 楽しむ",
                       @"形容詞\n利用可能な, 役立つ; 入手可能な, 求める[得る]ことができる\n\n手がすいて話す[会う]ことができる, 体があいて\n\n交際相手のいない, 恋人募集中の; 口説きやすい",
                       @"動詞～s/-ts/; ～; ～en/bíːt(ə)n/, ～; ～ing \n他動詞\n~を打つ, たたく, 連打する\n\nに激しく当たる, たたきつけるように吹く[降る, 打ち寄せる]\n\nドラム、太鼓をたたく\n\n~をなぐりつける, 殴打する, なぐって~にする\n\n懲罰として~を手[鞭, 棒]でぶつ, せっかんする; ぶって~にする\n\nを強く混ぜる, 泡立てる\n\n~を足で踏み固める\n\n~をたたいて薄くする, 打延して~にする\n\nほこりをたたき出す\n\n相手を打ち破る; ~に打ち勝つ; 競争に勝利する; 障害、問題を解決[打破]する; 従来の記録を上回る\n\n~にまさる, ~より優れる, ~をしのぐ\n\nを圧倒する, 困らせる, うんざり[閉口]させる\n\n自動詞\n打つ, たたく\n\n殴打する\n\n風、雨、波が激しく当たる, たたきつけるように吹く[降る, 打ち寄せる]\n\n心臓、脈が打つ, 鼓動[拍動]する\n\n泡立てるように混ぜる; 卵が泡立てられる\n\n名詞 複～s/-ts/\n連打すること; 連打の音, 時計のコチコチという音; 作動音\n\n 心臓の鼓動; 脈拍\n\n拍子, リズム, ビート; 強拍音\n\n警備員の巡回[パトロール]地区, 持ち場; 取材場所, 持ち場\n\n形容詞\nへとへとに疲れ切って",
                       @"形容詞～er; ～est\n輝いている; 光っている; うららかな; 明るい\n\n頭のいい, 利口\n\n気の利いた, うまく行きそうな\n\n鮮やかな, 鮮明な, 目立つ\n\n快活な, はつらつとした; 表情が生き生きとした, 輝いた ; 声が明瞭な\n\n未来が輝かしい, 明るい, 有望な\n\n副詞\n明るく, こうこうと輝く",
                       @"動詞～s/-ts/; ～d/-ɪd/; -brating\n他動詞\nを祝う, 祝賀する\n\n儀式、祭典を行う, 挙行する\n\nを世に知らせる, 称賛[賛美]する",
                       @"動詞～s/-z/; ～d/-d/; -mining\n他動詞\n事実、原因を特定する, 確定する; 位置、量を測定する\n\n~ということを突き止める, 確認する\n\nを決定する; 問題を解決する\n\n~ということを決定する\n\n事が物、事を左右する, 決定する\n\n~かどうかに影響を与える\n\n~しようと決心する; ~ということを決意する\n\n自動詞\n 決心する ; 決定[特定]する",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n自動詞\n 見えなくなる, 視界から消える\n\n消失する, 見当たらなくなる; 姿を消す, 失踪する; 消滅する, 存在しなくなる",
                       @"副詞\nそのほかの, 別の[に], それ以外の\n\n追加を示してそのほかに, さらに, その上",
                       @"形容詞～er/ferer|feərə/; ～est/ferəst|feərɪst/\n\n状況、システムが妥当な, 正しい; 価格が適正な\n\n状況、判断が公正な, 公平な, 人が差別をしない\n\n規則に従った\n\nかなりの, 相当の\n\nまずまずの, 平均的な; 成績が可の\n\n金髪の; 肌が色白の; 人が金髪で肌が白い\n\n副詞～er; ～est\n公正に, フェアに\n\n名詞 複～s/-z/\n品評会, 共進会",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n自動詞\n液体、気体、電流が一定の量で絶え間なく流れる; 血が循環する\n\n多くの人、物が絶え間なく動く, ぞろぞろ通る; 情報、金が行き来する, 流れる\n\nアルコールがたくさんふるまわれる\n\n言葉、アイデアがなめらかに出る\n\n名詞 複～s/-z/\n液体の流れ; 流出[流入]量\n\n人、車、金の動き, 行き来; 電気の絶え間ない供給; 移動[供給]量\n\n言葉、考えが流れるように出てくること\n\n満ち潮, 上げ潮",
                       @"副詞\n前へ, 前の方へ, 先へ; 先に進んで, 発展して\n\n将来に向かって, 時間的に先に; 日取りを繰り上げて\n\n物、人がさし出されて; 外へ, 現れて\n\n形容詞\n前方の; 船、車、建物の前部の; 前進の\n\n将来の, 先を見越した;先物の取引、契約\n\n普通より早い; 進んだ; 仕事がはかどった; 植物が早生りの, 早咲きの; 子供が早熟な, ませた\n\n動詞\n他動詞\n手紙、電子メールを転送する\n\n物を送る, 発送する",
                       @"名詞 複～s/-z/\n丘, 小山; 丘陵地帯\n\n坂, 斜面\n\n米国議会\n\n塚; 山状のもの",
                       @"名詞 複～s/-z/\n数量、規模の程度, 度合い, レベル\n\n技能、能力の水準, レベル\n\n物事をとらえる段階, 面; 観点, 見地\n\n組織での階層, 地位, レベル; 特定の地位を占める人々\n\n地面、海面からの高さ; ある基準からの高さ, 水位; ある高さの水平面; 水平\n\n建物の階\n\n形容詞～er; ～est\n平らな, 水平な; 傾いていない; 起伏のない\n\n同じ高さ[水準]の; 対等の, 同程度の; チームが同点の\n\n動詞～s/-z/; ～ed/-d/, ; ～ing\n\n他動詞\n~を平らにする; ~の表面をならす\n\n災害が建物、地域を完全に破壊する; 人を打ち倒す\n\n~を平等[一様]にする;  得点を同じにする\n\n銃を向ける; 非難、批判を向ける",
                       ...
                       @"動詞～s/-ts/; ～d/-ɪd/; -cating\n自動詞\n言葉身ぶりで~と情報[意見]を交換する, 通信する, 連絡をとる\n\n自分の意図を伝達する\n\n~と意思の疎通をする, 気持ちを通い合わせる\n\n部屋、機器がつながっている, 通じている\n\n人の気持ち、情報が伝わる, 伝達される\n\n他動詞\n情報、意図、感情を伝える, 伝達する; 感情が~に伝わる; ~だと伝える",
                       ...
                       @"形容詞more ～; most ～\n正確な, 的確な, ぴったりの; まさにその\n\n方法が厳密な, 精密な; 人が慎重な, きちょうめんな\n\n規則が厳しい, 厳格な",
                       @"形容詞～er; ～est\n新しい, できたての; ありきたりではない, 使い古されていない; 新着の, 新規の; 追加の; 未使用の, 未知の\n\n記憶に新しい; 鮮明な, 生々しい\n\n新鮮な;冷凍[缶詰]されてない, 生の; 花が摘まれたばかりの; 水が淡水の, 真水の; バターが無塩の\n\n空気がすがすがしい; さわやかな味香り; 鮮やかな, 明るい色; 健康的な, 紅潮している\n\n元気な, 疲れていない\n\n新米の, 未熟な; うぶな; したばかりの\n\n失礼な, 生意気な;なれなれしい\n\n副詞\n新たに~した, ~したばかりの\n\n名詞\n最初の時期",
                       @"動詞～s/-z/; ～ed/-d/; ～ing/ɡǽð(ə)rɪŋ/\n\n~を集める, かき[拾い]集める\n\n情報、証拠を収集する, 集める\n\n~を推測する ; ~だと推測する[思う]\n\n速度、力、強さを増す\n\n勇気、思考をふるい起こす, 集中する\n\n自動詞\n集まる, 群がる\n\n雲が次第に厚くなる; 暗やみが迫る",
                       @"動詞～s/-ts/; ～d/-ɪd/; -cating\n他動詞\n~が~ということを示す, 指摘する\n\n道を 手、指を使って指し示す; 測定器が数値を表示する\n\n~が~ということを暗に知らせる ,ほのめかす; 意味する\n\n~の徴候を示す, ~を表す, ~の兆しである",
                       @"名詞 複～s/-z/\n項目, 品目, アイテム; 細目; 条項\n\n記事、ニュースの1項目, 短い記事",
                       @"動詞～s/-z/; ～ed/-d/; ～ing/-f(ə)rɪŋ/\n他動詞\n協力、援助を申し出る; 好意から人に物を差し出す[提供する]; 志願する ; 身をささげる ; 名乗る\n\n他人のために進んで~しようと申し出る\n\n~に対して金額を提示する, オファーする\n\n忠告、情報を与える; 機会を提供する; 会社、団体が製品、サービスを提供する\n\n感謝、同情、謝罪を示す\n\nを売り出す\n\n抵抗、暴力を試みる\n\n自動詞\n援助[協力]を申し出る; 食事を勧める\n\n名詞複～s/-z/\n援助、協力をしようという申し出 ; プロポーズ\n\n取引希望価格, 付け値, オファー\n\n短期間の値引き, 割引",
                       @"名詞 複～s/-ɪz/\n値段, 販売価格; 売り値; 物価 \n\n代償, 犠牲\n\n懸賞金\n\n動詞\n他動詞\n~の値が付いている",
                       @"名詞 複～s/-ts/\n製品, 生産物, 製造物, 作品; 保険の商品\n\n経験、状況の成果, 産物, 所産, 結果",
                       @"名詞 複-ties/-z/\n財産, 資産; 所有\n\n不動産; 土地, 建物\n\n特性, 属性, 特質\n\n土地、財産の所有権; 著作権",
                       @"動詞～s/-ɪz/; ～d/-t/; -chasing\n他動詞\n大きな物、高額な物を買う, 購入する\n\n勝利、自由を (犠牲を払って)獲得する, 手に入れる\n\n名詞 複～s/-ɪz/\n購入\n\n買った物, 購入品\n\nしっかりとつかむ[握る, 踏む]こと; 手[足]がかり",
                       @"動詞～s/-dz/; ～ed/-ɪd/; ～ing\n他動詞\n~すべきだと勧める\n\n~することを勧める\n\n~するように勧める\n\n~に推薦する, 推奨する ; ~を推薦する\n\n人、物を魅力的にする, 気に入らせる\n\n自動詞\n~を勧めない.",
                       ...
                       @"名詞 複～s/-z/\n推論による結論, 決定, 判定 «that節»\n\n行為、話、文章の終わりの部分, 結末, 結び; 裁判、交渉の決着; 終わること\n\n合意、契約の締結, 取り決め.",
                       @"名詞 複～s/-ts/\n疑い, 疑念, 疑惑, 疑義\n\n動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n~を疑う, は本当だろうかと思う; ~ということを疑う\n\n事がありそうにないと思う;~ではないと思う\n\nを信用しない",
                       @"動詞～s/-z/; ～d/-d/; exploring/-plɔ́ːrɪŋ/\n他動詞\nを探検する, 踏査[探査]する; ~を求めて 場所を調査する\n\n~を探究する, 検討する, 探る; ~かを調べる\n\n自動詞\n資源を求めて探検する, 踏査する",
                       @"形容詞\n外国の, 他国の; 外国から[行き]の; 外国産の; 外国人の\n\n外交の, 対外的な",
                       @"形容詞～der; ～dest\n~ということがうれしい ; うれしく思う\n\n喜んで~する\n\nうれしい, 喜ばしい表情、知らせ",
                       @"副詞\nしかしながら, けれども; 一方では\n\nいかに[どんなに]~であっても[しても]\n\n不明な数量を表してどのくらい~かわからない数[量]\n\nいろいろな意見を述べた後に本論に戻そうとして どのようであっても, いずれにしても\n\n驚きを表していったいどうやって\n\n接続詞\nどのように~しても",
                       @"名詞 複～s/-ɪz/\n権利の侵害, 不公平; 不正, 非道\n\n不正行為; 不当な扱い",
                       @"形容詞\n国際的な, 国家間の, 国際上の",
                       @"名詞 複～s/-z/\n法律家, 弁護士; 法律通",
                       @"動詞～s/-z/; ～ed; ～ing\n他動詞\n人、物、事に軽くふれる; 名前を挙げる, ~の名を挙げる; ~について言及する\n\n~すると言う; ~だと述べる, 言う\n\n称賛[非難]される; 人が仕事の候補者にされる\n\n言うこと; 言及すること; 名を挙げること",
                       @"名詞 複-cies/-z/\n政策, 方針, 施策, 方策\n\n信条, 主義, やり方; 知恵\n\n保険証券, 保険証書",
                       @"形容詞\n社会の, 社会に関する, 社会的な\n\n社会的階級[地位]に関する\n\n社交の, 懇親の活動、会; 社交上の\n\n社交的な, 人付き合いのよい",
                       ...
                       @"動詞～s/-z/; ～d/-d/; achieving\n他動詞\n地位、成功を獲得する, 得る, 受ける; よい結果を得る, 生み出す, もたらす\n\n課題、目的、一定の水準を達成[完了]する, やり遂げる\n\n自動詞\n成功をおさめる, 目的を達成する",
                       @"動詞～s/-ɪz/; ～d/-d/; advising\n他動詞\n専門家、物、事にくわしい人がに~するよう忠告する[強く勧める]\n\n~ということを忠告する\n\n~しないよう警告する, 戒める; ~をしないよう忠告する\n\n~について専門的助言をする\n\n~を勧める\n\n自動詞\n忠告[助言]する\n\n相談する, 助言を求める\n\n通知する",
                       @"副詞\nもう, すでに\n\nもう; 驚いてそんなに早く\n\nもういいかげん",
                       @"形容詞more ～; most ～\n重要な, 基本の, 基礎になる構造、活動、原則; 必要な; 不可欠の\n\n初歩的な, 基本的な\n\n簡素な, 必要最小限の; 最低限の価格、収入\n\nだれもが持つ感情、権利\n\n名詞\n重要な[基本的な]事実, 基本原理, 初歩",
                       @"名詞 複～s/-ts/\n(程度の点で)ちょっと, 少し, 少々\n\n時間、距離の点で少し\n\n少しの~, 少量[一口, 一切れ, 一片]の~; 1つの~\n\n小さい部分, 小片; 物語、映画の一部分, 一場面; 劇、映画の端役",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n他動詞\n~を[~しようかと]よく考える, 熟慮[検討]する; ~かをよく考える\n\n~を~と考える, 思う, 見なす ; ~だと考える; ~を~したものと考える\n\n人の気持ちを思いやる, ~に配慮する; (決定の際に)事実を考慮する, 斟酌する; ~ということを考慮する\n\n報告、問題を議論する; ~を検討する\n\n自動詞\nよく考える, 熟慮する, 考えてみる; 考慮[斟酌]する",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n他動詞\nを破壊する, 壊す; ~を滅ぼす\n\nを破滅させる; 関係、経歴を台なしにする; 自信、希望を打ち砕く, くじく\n\n主に動物が殺される, 処分される\n\n文書を破棄する, 破り捨てる",
                       @"動詞～s/-z/; ～ed/-d/; ～ing\n他動詞\n人をおもしろがらせる, 楽しませる\n\n人をもてなす, 接待する, 歓待する ; 人を招待してもてなす\n\n考え、希望、疑いをいだく, 持つ; 提案を考慮する ",
                       @"形容詞\n追加の, 余分の, 特別の, 臨時の\n\n余分に料金がいる\n\n特別上等の, 格別の\n\n副詞\n余分に, 追加で, 割り増しで\n\n格別に, いつもより\n\n名詞\nオプション製品[サービス]; 追加料金\n\n余分なもの, 予備\n\nエキストラ\n\n臨時雇いの人\n\n接頭辞\n外側の; 範囲外の; ~を越えた; その上に",
                       @"名詞 複～s/-z/\n目標, 目的\n\nゴール; ゴールに入った得点\n\nレースのフィニッシュライン\n\n目的地, 行き先",
                       @"動詞～s/-z/; ～d/-d/; lying\n\n自動詞\nうそをつく\n\n欺く, 間違った印象を与える\n\n他動詞\nをだまして~に陥れる, にうそをついて~させる ; 人をだまして金を巻き上げる\n\n名詞 複～s/-z/\nうそ, 虚偽",
                       @"名詞 複～s/-ts/\n食用の肉; 骨の周りの身; 肉付き\n\n木の実、卵、貝カニの身; 果肉\n\n要点, 骨子, 内容",
                       @"名詞 複～s/-z/\n意見, 考え, 見解, 持論\n\n~についての~な評価\n\n世論, 世間の考え\n\n専門家の判断, 所見, 鑑定",
                       @"形容詞more ～; most ～\n実在する; 現実の, 実際の\n\n本当の, 真の; 本物の\n\nまったくの, すごい\n\nその名に値する, 真の意味での\n\n最も重要な\n\n心からの, 本気の\n\n実質の賃金、収入\n\n情景、描写が真に迫った, リアルな",
                       @"動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n光、熱を反射する; 音を反響する\n\n状況、感情を反映する, 表す, 示す; ~であるかを反映する\n\n~ということを熟考する, よく考える\n\n~が鏡に映る, 映し出される\n\n信用、不信を 結果としてもたらす, 招く\n\n自動詞\n光、熱が反射する; 音が反響する\n\n熟考する\n\n出来事、状況が影響を及ぼす, 印象[評判]をもたらす",
                       @"動詞～s/-dz/; ～ed/-ɪd/; ～ing\n他動詞\n~とみなす, 考える\n\n~を考える, 捉える ; ~を評価する, ~を尊敬する\n\n名詞 複～s/-dz/\n敬意, 尊敬; 好意; 評価\n\n配慮, 思いやり; 考慮, 注意\n\n手紙、伝言のよろしくというあいさつ",
                       @"動詞～s/-z/; ～d/-d/; serving\n他動詞\n 飲食物を人に出す, 供する; 飲食物を出す, 配る; 飲食物を出す; 飲食物を~で出す; 飲食物を出す\n\n料理が~人分である\n\n目的、必要、利益にかなう, 機能を果たす; 人の役に立つ, 人を助ける; 人を満足させる\n\n組織、会社のために働く, ~に勤務する; のために働く, ~に仕える; 使用人として家族、場所に奉公する\n\n期間、任期を務める\n\n客の世話をする, ~に応対する; 商品を売る\n\n商品、サービスを人、地域に提供する\n\n正式文書を渡す[送付する]; 召喚状を渡す[送付する]\n\n自動詞\n 役立つ, 用をなす, 間に合う\n\n 勤務する, 務める, 働く, 仕事をする\n\n使用人として奉公する\n\n飲食物を出す, 給仕する; ~のままで出す",
                       @"名詞 複～s/-z/\n野菜; 温野菜\n\n植物, 草木\n\n形容詞\n野菜の; 植物性の",
                       @"名詞 複～s/-z/\n戦争, 紛争; 戦時\n\n長期的な闘い, 争い\n\n権力、支配をめぐる争い, 戦争\n\n形容詞\n戦争の; 戦争に用いる; 戦争で生じた",
                       @"前置詞\nある金額の[に匹敵する]価値がある, 値打ちがある; 金に換算して~に相当する\n\n行為、努力の価値がある, ~だけのことはある\n\n~する価値がある\n\n~するのは価値がある, それだけのことがあるから~すべきである\n\n名詞\nある金額相当の物\n\nある期間分の食料, ある期間かかる仕事\n\n価値, 重要性",*/ nil];
    ...
    if ([wordNo isEqualToString:@"21"]) {
        ...
        changeHatuonLabel = [NSMutableArray arrayWithObjects:
                             ...
                             @"rɪfjúːz", @"ðoʊ", @"véəriəs",/* @"ǽktʃu(ə)l", @"əméɪz", @"tʃɑːrdʒ",
                                                               @"kʌ́mfərt", @"kɑ́ntækt|kɔ́n-", @"kʌ́stəmər", @"dɪlɪ́vər",
                                                               @"əːrn", @"ɡeɪt", @"ɪnklúːd", @"mǽnɪdʒ", @"mɪ́st(ə)ri", @"əkə́ːr",
                                                               @"ɑ́pəzɪt, -sɪt|ɔ́pəzɪt, -sɪt", @"pleɪt",
                                                               @"rɪsíːv", @"rɪwɔ́ːrd", @"set", @"stiːl", @"θiːf", @"ədvǽns|-vɑ́ːns", @"ǽθliːt",
                                                               @"ǽv(ə)rɪdʒ", @"bɪhéɪvjər", @"bɪháɪnd", @"kɔːrs", @"lóʊər", @"mætʃ", @"mémbər",
                                                               @"mént(ə)l", @"pǽsɪn(d)ʒər", @"pə̀ːrsənǽləti",@"póʊəm",@"poʊl",@"rɪmúːv",@"séɪfti",
                                                               @"ʃuːt", @"saʊnd", @"swɪm", @"web",@"blɑk|blɔk",@"tʃɪər",@"kɑ̀mpléks|kɔ́mpleks",@"krɪ́tɪk",
                                                               @"ɪvént",@"éksərsàɪz",@"fɪt",@"frén(d)ʃɪ̀p",@"ɡaɪd",@"læk",@"pǽsɪdʒ",
                                                               @"pərfɔ́ːrm", @"préʃər", @"prɑ́bəb(ə)l|prɔ́b-", @"pʌ́blɪk", @"straɪk", @"səpɔ́ːrt",
                                                               @"tæsk|tɑːsk", @"təːrm", @"junáɪt",
                                                               @"əsóʊʃièɪt", @"ɪnváɪ(ə)r(ə)nmənt", @"fǽkt(ə)ri", @"fíːtʃər", @"ɪ́nst(ə)ns", @"ɪnvɑ́lv|-vɔ́lv",
                                                               @"méds(ə)n, médɪ-", @"mɪks", @"ɔ́ːrɡənàɪz", @"píəriəd", @"pɑ́pjəlèɪt|pɔ́pju-", @"prədjúːs", @"reɪn(d)ʒ",
                                                               @"rékəɡnàɪz", @"réɡjələr", @"saɪn", @"tɪp", @"trədɪ́ʃ(ə)n", @"træʃ", @"waɪd",*/ nil];
        ...
        changeText = [NSMutableArray arrayWithObjects:
                      ...
                      /*
                       ...
                       @"名詞 複～s/-dz/\nほうび, 報酬, 報奨, 報い\n\n謝礼金, 懸賞金\n\n動詞\n他動詞\n~に報酬を与える, 謝礼する, 償う",
                       @"動詞～s/-ts/; ～; ～ting\n他動詞\n置く, 並べる, 立てかける\n\nはめ[埋め]込まれている\n\n位置している\n\n~を配置する; ~を配属する\n\n~を~の~にする\n\n~に~させる; ~し始める, ~しようと努める\n\n食卓の用意をする\n\n~を作る, ~を打ち立てる, 確立する; ~を示す\n\n時計、ビデオを合わせる; ~を設定する\n\n劇、小説、映画が設定される\n\n日時、価格、目標を決める; 規則、基準、条件、制限を定める\n\n~を考える\n\n心、目を集中させる; ~を向ける\n\n骨を接ぐ, 整骨する, 固定する\n\n髪を整える, セットする\n\n目標、任務を課す, 制限を設ける; ~するよう自分に目標を課す\n\n課題を出す; 問題を書く[作る]; 参考書を指定する\n\n価値を置く; ~を見積もる, 評価する\n\n火をつける\n\n自動詞\n液状ゼラチン状のものが固まる; 染料が固着する, 染みつく\n\n太陽、月が沈む\n\n名詞 複～s/-ts/\nひとそろいの~, ~のセット, ~一式\n\nひとそろい, ひと組\n\nテレビ受像機, ラジオ受信機; ヘッドホン装置\n\n撮影現場\n\n大道具, 舞台装置, セット\n\n髪のセット\n\n形容詞\nあらかじめ決められた, 定められた; 規定どおりの\n\nに反対しようと/~を心に決めている\n\n不変の, 固定した; 決意の固い; 頑固な, 変える意志を持たない\n\n用意ができている\n\n~しそうである\n\n卵が固まって",
                       @"動詞～s/-z/; stole/stoʊl/; stolen/stóʊl(ə)n/; ～ing\n盗む; 盗用する\n\nこっそり盗み見、キスをする; ~をこっそり動かす",
                       @"名詞 複thieves/θiːvz/\n泥棒, こそどろ",
                       
                       @"名詞 複～s/-ɪz/\n発展, 進歩, 進展, 革新; 発展[進歩]した物 \n\n前進; 進軍\n\n前払い金, 前貸し[貸し付け](金), 前渡し(商品) \n\n値上がり\n\n形容詞\n事前の, 前もっての\n\n前売り切符, 先行販売、購入\n\n動詞～s/-ɪz/; ～d/-t/; advancing\n他動詞\n理想、職歴、計画を促進する, 推進する, 利益、経済を増進[発展, 進歩]させる\n\n自動詞\n前進する, 進む, 迫る\n\n進軍する, 進撃[攻撃]する\n\n終わりの方まで進む, 進行する\n\n昇進[昇格]する",
                       @"名詞 複～s/-ts/\n運動[スポーツ]選手\n\nスポーツマン, 運動の得意な人",
                       ...
                       @"名詞 複～s/-ɪz/\n進路, 進む方向\n\n進行, 成り行き, 経過\n\n方針, 道, 方向\n\nコース, 課程, 連続講座\n\nコース料理の1品, 1皿\n\nコース, 走路\n\n動詞\n自動詞\n涙、血液が勢いよく流れる",
                       @"形容詞\n低い方の, 下部の\n\n下級の, 下層の; 下位の, 下等の\n\n下流の; 南部の\n\nより少ない\n\n動詞～s/-z/; ～ed/-d/; ～ing\n他動詞\n~を下ろす; 頭、目を下に向ける; ~の位置を低くする; 身を沈める\n\n価格、程度、量、音調を下げる, 落とす, 低下させる, 安くする\n\n自動詞\n価格、程度、量、声が下がる, 落ちる, 低下する, 下落する, 安くなる, 弱まる; 減る",
                       ...
                       @"名詞 複～s/-dz/\n期間, 時期; ~期間\n\n発達時期[段階, 過程]/ 病気の潜伏期\n\n時代\n\n月経期間[周期]\n\n時間, 時限\n\n終止符, ピリオド\n\n終わり",
                       @"動詞\n他動詞\n住む, 棲息する/ 特定の集団が~を満たす; 登場人物が現れる\n\n入植させる, 住まわせる",
                       @"動詞～s/-ɪz/; ～d/-t/; -ducing\n他動詞\n~を産み出す, 農産物を産出する, 生産する; 優秀な人物を輩出する\n\n結果、効果をもたらす, 災害、病気を引き起こす\n\n~を取り出す; ~を提出する, 示す\n\n~を製造する; 映画を制作する; ~を演出する, プロデュースする, 上演する, 放送する; ~を出版する\n\n名詞/próʊdjuːs|prɔ́d-/\n生産物, 農産物, 青果物; 生産高",
                       @"名詞 複～s/-ɪz/\n広範囲の~, 多種多様な~\n\n範囲, 幅\n\n権限、責任の及ぶ領域, 範囲\n\n種類, 品ぞろえ\n\n視力[聴力]の範囲\n\n射程距離\n\n航続距離\n\n動詞～s/-ɪz/; ～d/-d/; ranging\n自動詞\n価格、温度、程度が~に及ぶ\n\n感情、行動が~に及ぶ \n\n話、著作が~にわたる, 及ぶ",
                       @"動詞～s/-ɪz/; ～d/-d/; -nizing\n他動詞\nわかる, ~を認識[判別, 識別]する\n\n認める, 承認[認可]する\n\n評価される; 価値を認められる\n\n~を認める",
    ...
    if ([wordNo isEqualToString:@"26"]) {
        changeLabel = [NSArray arrayWithObjects:
                       ...
                       @"situated", @"society", @"standard", @"suggest",/* @"actually", @"bite", @"coast", @"deal",
                                                                         ...
                                                                         @"independent", @"inside", @"master", @"memory", @"proper", @"scan", @"imply",
                                                                         @"section", @"surface",*/ nil];
        ...
        changeHatuonLabel = [NSMutableArray arrayWithObjects:
                             ...
                             @"stǽndərd", @"səɡdʒést|sədʒést",/* @"ǽktʃu(ə)li", @"baɪt", @"koʊst", @"diːl",
                                                                  @"dézərt", @"ə́ːrθkwèɪk", @"ɪféktɪv", @"ɪɡzǽmɪn",
                                                                  @"fɔːls", @"ɡɪft", @"hʌ́ŋɡər", @"ɪmǽdʒɪn", @"dʒə́ːrni", @"pʌ́z(ə)l",
                                                                  @"kwaɪt", @"rǽðər|rɑ́ːðə",  @"spəsɪ́fɪk",
                                                                  @"tʊər", @"trɪp", @"vǽljuː", @"bænd", @"béərli", @"bɔ́ːrɪŋ", @"kǽns(ə)l",
                                                                  @"draɪvweɪ", @"ɡɑ́ːrbɪdʒ", @"ɪ́nstrəmənt", @"lɪst", @"mǽdʒɪk", @"mésɪdʒ",
                                                                  @"nóʊtəs", @"oʊn", @"prɪdɪ́kt",@"prəfésər",@"rʌʃ",@"skédʒuːl|ʃédjuːl, skédjuːl",@"ʃeər",
                                                                  @"steɪdʒ", @"stɔːrm", @"wɪðɪ́n", @"ǽdvərtàɪz",@"əsáɪn",@"ɔ́ːdiəns",@"brékfəst",
                                                                  @"kɑ̀mpətɪ́ʃ(ə)n|kɔ̀m-",
                                                                  @"kuːl",@"ɡeɪn",@"ɪmpɔ́ːrt(ə)ns",@"nɑ́lɪdʒ|nɔ́l-",@"méɪdʒər",@"miːn",@"prɪfə́ːr",
                                                                  @"prézɪd(ə)nt", @"prɑ́ɡrəs|prə́ʊɡres", @"rɪspékt", @"rɪtʃ", @"skɪl", @"sʌ́mhàʊ",
                                                                  @"streŋθ", @"voʊt", @"əbʌ́v",
                                                                  @"əhéd", @"əmáʊnt", @"bɪlíːf, bə-", @"séntər", @"kɑ́mən|kɔ́m-", @"kɔːst|kɔst",
                                                                  @"démənstrèɪt", @"dɪ́fr(ə)nt", @"évɪd(ə)ns", @"ɑ́nəsti|ɔ́n-", @"ɪ́diəm", @"ɪ̀ndɪpénd(ə)nt",
                                                                  @"ɪnsáɪd",
                                                                  @"mǽstər|mɑ́ːs-", @"mém(ə)ri", @"prɑ́pər|prɔ́p-", @"skæn", @"ɪmpláɪ", @"sékʃ(ə)n",
                                                                  @"sə́ːrfəs",*/ nil];
        ...
        changeText = [NSMutableArray arrayWithObjects:
                      ...
                      /*
                       ...
                       @"前置詞\n~の上に, ~の真上に, ~の上方に, ~より高く ; ~を見下ろす位置にある;~より北に\n\nを超えて, ~より上で, ~以上で\n\n~より優先して, 重視して\n\n地位、権力の点で~より上の\n\n他の音より大きく[高く], よく通って\n\n超越して, ~しない, ~を受けない;<否定文で>恥ずべき行為をすることができる, ~のようなことまでする\n\n~より上流に\n\n副詞\n上に, 真上に, 高い所に\n\n数値、水準の点でより上で\n\n地位、権力の点でより上で\n\n形容詞\n上述の, 上記の",

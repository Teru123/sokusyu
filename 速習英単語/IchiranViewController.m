...
@property (nonatomic, strong) NSString *readWord;
...
- (void)viewDidLoad
{
    ...
    */
    ...
    if ([wordNameForString isEqualToString:@"1. afraid"]) {
        self.readWord = @"afraid";
    ...
    if ([wordNameForString isEqualToString:@"1. agree"]) {
        self.readWord = @"agree";
    ...
    if ([wordNameForString isEqualToString:@"1. angry"]) {
        self.readWord = @"angry";
    ...
    if ([wordNameForString isEqualToString:@"1. arrive"]) {
        self.readWord = @"arrive";
    ...
    if ([wordNameForString isEqualToString:@"1. attack"]) {
        self.readWord = @"attack";
    ...
    if ([wordNameForString isEqualToString:@"1. bottom"]) {
        self.readWord = @"bottom";
    ...
    if ([wordNameForString isEqualToString:@"1. clever"]) {
        self.readWord = @"clever";
    ...
    if ([wordNameForString isEqualToString:@"1. cruel"]) {
        self.readWord = @"cruel";
    ...
    if ([wordNameForString isEqualToString:@"1. finally"]) {
        self.readWord = @"finally";
    ...
    if ([wordNameForString isEqualToString:@"1. hide"]) {
        self.readWord = @"hide";
    ...
    if ([wordNameForString isEqualToString:@"1. hunt"]) {
        self.readWord = @"hunt";
    ...
    if ([wordNameForString isEqualToString:@"1. lot"]) {
        self.readWord = @"lot";
    ...
    if ([wordNameForString isEqualToString:@"1. middle"]) {
        self.readWord = @"middle";
    ...
    if ([wordNameForString isEqualToString:@"1. moment"]) {
        self.readWord = @"moment";
    ...
    if ([wordNameForString isEqualToString:@"1. pleased"]) {
        self.readWord = @"pleased";
    ...
    if ([wordNameForString isEqualToString:@"1. promise"]) {
        self.readWord = @"promise";
    ...
    if ([wordNameForString isEqualToString:@"1. reply"]) {
        self.readWord = @"reply";
    ...
    if ([wordNameForString isEqualToString:@"1. safe"]) {
        self.readWord = @"safe";
    ...
    if ([wordNameForString isEqualToString:@"1. trick"]) {
        self.readWord = @"trick";
    ...
    if ([wordNameForString isEqualToString:@"1. well"]) {
        self.readWord = @"well";
    ...
    if ([wordNameForString isEqualToString:@"2. adventure"]) {
        self.readWord = @"adventure";
    ...
    if ([wordNameForString isEqualToString:@"2. approach"]) {
        self.readWord = @"approach";
    ...
    if ([wordNameForString isEqualToString:@"2. carefully"]) {
        self.readWord = @"carefully";
    ...
    if ([wordNameForString isEqualToString:@"2. chemical"]) {
        self.readWord = @"chemical";
    ...
    if ([wordNameForString isEqualToString:@"2. create"]) {
        self.readWord = @"create";
    ...
    if ([wordNameForString isEqualToString:@"2. evil"]) {
        self.readWord = @"evil";
        ewTextView.text =  @"形容詞～er; ～est\n悪い, 邪悪な; ~が悪意に満ちた\n\n害を及ぼす, 有害な\n\nひどく不快な, いやな; 評判が悪い\nWhat an evil smell!\nなんてにおいだ！\n\n名詞 複～s/-z/\n害悪, 弊害\n\n副詞\n悪く";
        [hatuonLabel setText:[NSString stringWithFormat:@"íːv(ə)l"]];
        reibun = @"What an evil smell!";
    }
    if ([wordNameForString isEqualToString:@"2. experiment"]) {
        self.readWord = @"experiment";
    ...
    if ([wordNameForString isEqualToString:@"2. kill"]) {
        self.readWord = @"kill";
    ...
    if ([wordNameForString isEqualToString:@"2. laboratory"]) {
        self.readWord = @"laboratory";
    ...
    if ([wordNameForString isEqualToString:@"2. laugh"]) {
        self.readWord = @"laugh";
    ...
    if ([wordNameForString isEqualToString:@"2. loud"]) {
        self.readWord = @"loud";
    ...
    if ([wordNameForString isEqualToString:@"2. nervous"]) {
        self.readWord = @"nervous";
    ...
    if ([wordNameForString isEqualToString:@"2. noise"]) {
        self.readWord = @"noise";
    ...
    if ([wordNameForString isEqualToString:@"2. project"]) {
        self.readWord = @"project";
    ...
    if ([wordNameForString isEqualToString:@"2. scare"]) {
        self.readWord = @"scare";
    ...
    if ([wordNameForString isEqualToString:@"2. secret"]) {
        self.readWord = @"secret";
    ...
    if ([wordNameForString isEqualToString:@"2. shout"]) {
        self.readWord = @"shout";
    ...
    if ([wordNameForString isEqualToString:@"2. smell"]) {
        self.readWord = @"smell";
    ...
    if ([wordNameForString isEqualToString:@"2. terrible"]) {
        self.readWord = @"terrible";
    ...
    if ([wordNameForString isEqualToString:@"2. worse"]) {
        self.readWord = @"worse";
    ...
    if ([wordNameForString isEqualToString:@"3. alien"]) {
        self.readWord = @"alien";
    ...
    if ([wordNameForString isEqualToString:@"3. among"]) {
        self.readWord = @"among";
    ...
    if ([wordNameForString isEqualToString:@"3. chart"]) {
        self.readWord = @"chart";
    ...
    if ([wordNameForString isEqualToString:@"3. cloud"]) {
        self.readWord = @"cloud";
    ...
    if ([wordNameForString isEqualToString:@"3. comprehend"]) {
        self.readWord = @"comprehend";
    ...
    if ([wordNameForString isEqualToString:@"3. describe"]) {
        self.readWord = @"describe";
    ...
    if ([wordNameForString isEqualToString:@"3. ever"]) {
        self.readWord = @"ever";
    ...
    if ([wordNameForString isEqualToString:@"3. fail"]) {
        self.readWord = @"fail";
    ...
    if ([wordNameForString isEqualToString:@"3. friendly"]) {
        self.readWord = @"friendly";
    ...
    if ([wordNameForString isEqualToString:@"3. grade"]) {
        self.readWord = @"grade";
    ...
    if ([wordNameForString isEqualToString:@"3. instead"]) {
        self.readWord = @"instead";
    ...
    if ([wordNameForString isEqualToString:@"3. library"]) {
        self.readWord = @"library";
        ewTextView.text =  @"名詞 複-ies/-z/\n図書館; 図書室";
        [hatuonLabel setText:[NSString stringWithFormat:@"láɪbrèri|-br(ə)ri, -b(ə)ri"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"3. planet"]) {
        self.readWord = @"planet";
        ewTextView.text =  @"名詞 複～s/-ts/\n惑星\n\n世界, 地球全体";
        [hatuonLabel setText:[NSString stringWithFormat:@"plǽnɪt"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"3. report"]) {
        self.readWord = @"report";
    ...
    if ([wordNameForString isEqualToString:@"3. several"]) {
        self.readWord = @"several";
    ...
    if ([wordNameForString isEqualToString:@"3. solve"]) {
        self.readWord = @"solve";
    ...
    if ([wordNameForString isEqualToString:@"3. suddenly"]) {
        self.readWord = @"suddenly";
    ...
    if ([wordNameForString isEqualToString:@"3. suppose"]) {
        self.readWord = @"suppose";
    ...
    if ([wordNameForString isEqualToString:@"3. universe"]) {
        self.readWord = @"universe";
        ewTextView.text =  @"名詞 複～s/-ɪz/\n宇宙; 万物, 森羅万象\n\n分野, 領域, 世界; 生活";
        [hatuonLabel setText:[NSString stringWithFormat:@"júːnɪvə̀ːrs"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"3. view"]) {
        self.readWord = @"view";
    ...
    if ([wordNameForString isEqualToString:@"4. appropriate"]) {
        self.readWord = @"appropriate";
    ...
    if ([wordNameForString isEqualToString:@"4. avoid"]) {
        self.readWord = @"avoid";
    ...
    if ([wordNameForString isEqualToString:@"4. behave"]) {
        self.readWord = @"behave";
    ...
    if ([wordNameForString isEqualToString:@"4. calm"]) {
        self.readWord = @"calm";
    ...
    if ([wordNameForString isEqualToString:@"4. concern"]) {
        self.readWord = @"concern";
    ...
    if ([wordNameForString isEqualToString:@"4. content"]) {
        self.readWord = @"content";
    ...
    if ([wordNameForString isEqualToString:@"4. expect"]) {
        self.readWord = @"expect";
    ...
    if ([wordNameForString isEqualToString:@"4. frequently"]) {
        self.readWord = @"frequently";
    ...
    if ([wordNameForString isEqualToString:@"4. habit"]) {
        self.readWord = @"habit";
    ...
    if ([wordNameForString isEqualToString:@"4. instruct"]) {
        self.readWord = @"instruct";
    ...
    if ([wordNameForString isEqualToString:@"4. issue"]) {
        self.readWord = @"issue";
    ...
    if ([wordNameForString isEqualToString:@"4. none"]) {
        self.readWord = @"none";
    ...
    if ([wordNameForString isEqualToString:@"4. patient"]) {
        self.readWord = @"patient";
    ...
    if ([wordNameForString isEqualToString:@"4. positive"]) {
        self.readWord = @"positive";
    ...
    if ([wordNameForString isEqualToString:@"4. punish"]) {
        self.readWord = @"punish";
    ...
    if ([wordNameForString isEqualToString:@"4. represent"]) {
        self.readWord = @"represent";
    ...
    if ([wordNameForString isEqualToString:@"4. shake"]) {
        self.readWord = @"shake";
    ...
    if ([wordNameForString isEqualToString:@"4. spread"]) {
        self.readWord = @"spread";
    ...
    if ([wordNameForString isEqualToString:@"4. stroll"]) {
        self.readWord = @"stroll";
    ...
    if ([wordNameForString isEqualToString:@"4. village"]) {
        self.readWord = @"village";
        ewTextView.text =  @"名詞 複～s/-ɪz/\n村, 村落 \n\n村の\n\n村人たち";
        [hatuonLabel setText:[NSString stringWithFormat:@"vɪ́lɪdʒ"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"5. aware"]) {
        self.readWord = @"aware";
    ...
    if ([wordNameForString isEqualToString:@"5. badly"]) {
        self.readWord = @"badly";
    ...
    if ([wordNameForString isEqualToString:@"5. belong"]) {
        self.readWord = @"belong";
    ...
    if ([wordNameForString isEqualToString:@"5. continue"]) {
        self.readWord = @"continue";
    ...
    if ([wordNameForString isEqualToString:@"5. error"]) {
        self.readWord = @"error";
        ewTextView.text =  @"名詞 複～s/-z/\n間違い, 誤り, 過失, ミス\nThe accident was caused by human error.\nその事故は人為的過誤によるものだった。\n\n思い違い, 誤解, 勘違い";
        [hatuonLabel setText:[NSString stringWithFormat:@"érər"]];
        reibun = @"The accident was caused by human error.";
    }
    if ([wordNameForString isEqualToString:@"5. experience"]) {
        self.readWord = @"experience";
    ...
    if ([wordNameForString isEqualToString:@"5. field"]) {
        self.readWord = @"field";
    ...
    if ([wordNameForString isEqualToString:@"5. hurt"]) {
        self.readWord = @"hurt";
    ...
    if ([wordNameForString isEqualToString:@"5. judgment"]) {
        self.readWord = @"judgment";
    ...
    if ([wordNameForString isEqualToString:@"5. likely"]) {
        self.readWord = @"likely";
    ...
    if ([wordNameForString isEqualToString:@"5. normal"]) {
        self.readWord = @"normal";
    ...
    if ([wordNameForString isEqualToString:@"5. rare"]) {
        self.readWord = @"rare";
    ...
    if ([wordNameForString isEqualToString:@"5. relax"]) {
        self.readWord = @"relax";
        ewTextView.text =  @"動詞～es/-ɪz/; ～ed/-t/; ～ing\n他動詞\nくつろがせる, リラックスさせる\nI just want to sit down and relax.\n座って休みたいだけです。\n\n体をほぐす\n\n体がほぐれる";
        [hatuonLabel setText:[NSString stringWithFormat:@"rɪlǽks"]];
        reibun = @"I just want to sit down and relax.";
    }
    if ([wordNameForString isEqualToString:@"5. request"]) {
        self.readWord = @"request";
    ...
    if ([wordNameForString isEqualToString:@"5. reside"]) {
        self.readWord = @"reside";
    ...
    if ([wordNameForString isEqualToString:@"5. result"]) {
        self.readWord = @"result";
    ...
    if ([wordNameForString isEqualToString:@"5. roll"]) {
        self.readWord = @"roll";
    ...
    if ([wordNameForString isEqualToString:@"5. since"]) {
        self.readWord = @"since";
    ...
    if ([wordNameForString isEqualToString:@"5. visible"]) {
        self.readWord = @"visible";
    ...
    if ([wordNameForString isEqualToString:@"5. wild"]) {
        self.readWord = @"wild";
    ...
    if ([wordNameForString isEqualToString:@"6. advantage"]) {
        self.readWord = @"advantage";
    ...
    if ([wordNameForString isEqualToString:@"6. cause"]) {
        self.readWord = @"cause";
    ...
    if ([wordNameForString isEqualToString:@"6. choice"]) {
        self.readWord = @"choice";
    ...
    if ([wordNameForString isEqualToString:@"6. community"]) {
        self.readWord = @"community";
    ...
    if ([wordNameForString isEqualToString:@"6. dead"]) {
        self.readWord = @"dead";
    ...
    if ([wordNameForString isEqualToString:@"6. distance"]) {
        self.readWord = @"distance";
    ...
    if ([wordNameForString isEqualToString:@"6. escape"]) {
        self.readWord = @"escape";
    ...
    if ([wordNameForString isEqualToString:@"6. face"]) {
        self.readWord = @"face";
    ...
    if ([wordNameForString isEqualToString:@"6. follow"]) {
        self.readWord = @"follow";
    ...
    if ([wordNameForString isEqualToString:@"6. fright"]) {
        self.readWord = @"fright";
    ...
    if ([wordNameForString isEqualToString:@"6. ghost"]) {
        self.readWord = @"ghost";
        ewTextView.text =  @"名詞 複～s/-ts/\n幽霊, 亡霊\n\n幻影, 影 ; かすかな[ごくわずかの]";
        [hatuonLabel setText:[NSString stringWithFormat:@"ɡoʊst"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"6. individual"]) {
        self.readWord = @"individual";
    ...
    if ([wordNameForString isEqualToString:@"6. pet"]) {
        self.readWord = @"pet";
        ewTextView.text =  @"名詞 複～s/-ts/\nペット, 愛玩動物";
        [hatuonLabel setText:[NSString stringWithFormat:@"pet"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"6. reach"]) {
        self.readWord = @"reach";
    ...
    if ([wordNameForString isEqualToString:@"6. return"]) {
        self.readWord = @"return";
    ...
    if ([wordNameForString isEqualToString:@"6. survive"]) {
        self.readWord = @"survive";
    ...
    if ([wordNameForString isEqualToString:@"6. upset"]) {
        self.readWord = @"upset";
    ...
    if ([wordNameForString isEqualToString:@"6. voice"]) {
        self.readWord = @"voice";
    ...
    if ([wordNameForString isEqualToString:@"6. weather"]) {
        self.readWord = @"weather";
        ewTextView.text =  @"名詞\n天気, 天候, 気象; 天候の, 気象の\nWhat is the weather like today?\n今日はどんな天気ですか？\n\n天気予報, 気象情報.\n\n暴風雨; 悪天候\n\n動詞\n他動詞\n変色する, 風化する, 傷む; 日焼けする\n\n無事に乗り切る, うまく切り抜ける";
        [hatuonLabel setText:[NSString stringWithFormat:@"wéðər"]];
        reibun = @"What is the weather like today.";
    }
    if ([wordNameForString isEqualToString:@"6. wise"]) {
        self.readWord = @"wise";
    ...
    if ([wordNameForString isEqualToString:@"7. allow"]) {
        self.readWord = @"allow";
        ewTextView.text =  @"動詞～s/-z/; ～ed/-d/; ～ing\n他動詞\n~するのを許す ; ~させる; ~を許す, 認める\nYou are not allowed to smoke here.\nここで喫煙してはいけない。\n\n許可する \n\n~を与える\n\n時間、配分を見ておく, 充てる; 猶予する\n\n自動詞\n事が許される";
        [hatuonLabel setText:[NSString stringWithFormat:@"əláʊ"]];
        reibun = @"You are not allowed to smoke here.";
    }
    if ([wordNameForString isEqualToString:@"7. announce"]) {
        self.readWord = @"announce";
    ...
    if ([wordNameForString isEqualToString:@"7. beside"]) {
        self.readWord = @"beside";
    ...
    if ([wordNameForString isEqualToString:@"7. challenge"]) {
        self.readWord = @"challenge";
    ...
    if ([wordNameForString isEqualToString:@"7. claim"]) {
        self.readWord = @"claim";
    ...
    if ([wordNameForString isEqualToString:@"7. condition"]) {
        self.readWord = @"condition";
    ...
    if ([wordNameForString isEqualToString:@"7. contribute"]) {
        self.readWord = @"contribute";
    ...
    if ([wordNameForString isEqualToString:@"7. difference"]) {
        self.readWord = @"difference";
    ...
    if ([wordNameForString isEqualToString:@"7. divide"]) {
        self.readWord = @"divide";
    ...
    if ([wordNameForString isEqualToString:@"7. expert"]) {
        self.readWord = @"expert";
    ...
    if ([wordNameForString isEqualToString:@"7. famous"]) {
        self.readWord = @"famous";
    ...
    if ([wordNameForString isEqualToString:@"7. force"]) {
        self.readWord = @"force";
    ...
    if ([wordNameForString isEqualToString:@"7. harm"]) {
        self.readWord = @"harm";
    ...
    if ([wordNameForString isEqualToString:@"7. lay"]) {
        self.readWord = @"lay";
    ...
    if ([wordNameForString isEqualToString:@"7. peace"]) {
        self.readWord = @"peace";
    ...
    if ([wordNameForString isEqualToString:@"7. prince"]) {
        self.readWord = @"prince";
        ewTextView.text =  @"名詞 複～s/-ɪz/\n王子, 皇子, 親王\n\n君主, 公";
        [hatuonLabel setText:[NSString stringWithFormat:@"prɪns"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"7. protect"]) {
        self.readWord = @"protect";
    ...
    if ([wordNameForString isEqualToString:@"7. sense"]) {
        self.readWord = @"sense";
    ...
    if ([wordNameForString isEqualToString:@"7. sudden"]) {
        self.readWord = @"sudden";
    ...
    if ([wordNameForString isEqualToString:@"7. therefore"]) {
        self.readWord = @"therefore";
    ...
    if ([wordNameForString isEqualToString:@"8. accept"]) {
        self.readWord = @"accept";
    ...
    if ([wordNameForString isEqualToString:@"8. arrange"]) {
        self.readWord = @"arrange";
    ...
    if ([wordNameForString isEqualToString:@"8. attend"]) {
        self.readWord = @"attend";
    ...
    if ([wordNameForString isEqualToString:@"8. balance"]) {
        self.readWord = @"balance";
    ...
    if ([wordNameForString isEqualToString:@"8. contrast"]) {
        self.readWord = @"contrast";
    ...
    if ([wordNameForString isEqualToString:@"8. encourage"]) {
        self.readWord = @"encourage";
    ...
    if ([wordNameForString isEqualToString:@"8. familiar"]) {
        self.readWord = @"familiar";
    ...
    if ([wordNameForString isEqualToString:@"8. grab"]) {
        self.readWord = @"grab";
    ...
    if ([wordNameForString isEqualToString:@"8. hang"]) {
        self.readWord = @"hang";
    ...
    if ([wordNameForString isEqualToString:@"8. huge"]) {
        self.readWord = @"huge";
    ...
    if ([wordNameForString isEqualToString:@"8. necessary"]) {
        self.readWord = @"necessary";
    ...
    if ([wordNameForString isEqualToString:@"8. pattern"]) {
        self.readWord = @"pattern";
    ...
    if ([wordNameForString isEqualToString:@"8. propose"]) {
        self.readWord = @"propose";
    ...
    if ([wordNameForString isEqualToString:@"8. purpose"]) {
        self.readWord = @"purpose";
        ewTextView.text =  @"名詞 複～s/-ɪz/\n 目的, 意図, ねらい ; 理由, 趣旨\nWhat is the purpose of your visit?\nあなたの来訪の目的は何ですか？\n\n生きがい";
        [hatuonLabel setText:[NSString stringWithFormat:@"pə́ːrpəs"]];
        reibun = @"What is the purpose of your visit.";
    }
    if ([wordNameForString isEqualToString:@"8. release"]) {
        self.readWord = @"release";
    ...
    if ([wordNameForString isEqualToString:@"8. require"]) {
        self.readWord = @"require";
    ...
    if ([wordNameForString isEqualToString:@"8. single"]) {
        self.readWord = @"single";
    ...
    if ([wordNameForString isEqualToString:@"8. success"]) {
        self.readWord = @"success";
    ...
    if ([wordNameForString isEqualToString:@"8. tear"]) {
        self.readWord = @"tear";
    ...
    if ([wordNameForString isEqualToString:@"8. theory"]) {
        self.readWord = @"theory";
    ...
    if ([wordNameForString isEqualToString:@"9. against"]) {
        self.readWord = @"against";
    ...
    if ([wordNameForString isEqualToString:@"9. beach"]) {
        self.readWord = @"beach";
        ewTextView.text =  @"名詞 複～es/-əz/\n浜辺, 海岸, 湖岸; 砂浜, なぎさ";
        [hatuonLabel setText:[NSString stringWithFormat:@"biːtʃ"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"9. damage"]) {
        self.readWord = @"damage";
    ...
    if ([wordNameForString isEqualToString:@"9. discover"]) {
        self.readWord = @"discover";
    ...
    if ([wordNameForString isEqualToString:@"9. emotion"]) {
        self.readWord = @"emotion";
    ...
    if ([wordNameForString isEqualToString:@"9. fix"]) {
        self.readWord = @"fix";
    ...
    if ([wordNameForString isEqualToString:@"9. frank"]) {
        self.readWord = @"frank";
    ...
    if ([wordNameForString isEqualToString:@"9. identify"]) {
        self.readWord = @"identify";
    ...
    if ([wordNameForString isEqualToString:@"9. island"]) {
        self.readWord = @"island";
        ewTextView.text =  @"名詞 複～s/-dz/\n島; ~島;島の\n\n島に似たもの; 趣が周辺と異なる所";
        [hatuonLabel setText:[NSString stringWithFormat:@"áɪlənd"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"9. ocean"]) {
        self.readWord = @"ocean";
        ewTextView.text =  @"名詞 複～s/-z/\n海\n\n海洋, 大洋; ~洋, ~海\n\n膨大な量[広がり]";
        [hatuonLabel setText:[NSString stringWithFormat:@"óʊʃ(ə)n"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"9. perhaps"]) {
        self.readWord = @"perhaps";
    ...
    if ([wordNameForString isEqualToString:@"9. pleasant"]) {
        self.readWord = @"pleasant";
    ...
    if ([wordNameForString isEqualToString:@"9. prevent"]) {
        self.readWord = @"prevent";
    ...
    if ([wordNameForString isEqualToString:@"9. rock"]) {
        self.readWord = @"rock";
        ewTextView.text =  @"名詞 複～s/-s/\n岩, 岩盤, 岩壁, 岩山\n\n岩石, 岩;石, 小石\n\n暗礁, 岩礁";
        [hatuonLabel setText:[NSString stringWithFormat:@"rɑk|rɔk"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"9. save"]) {
        self.readWord = @"save";
    ...
    if ([wordNameForString isEqualToString:@"9. step"]) {
        self.readWord = @"step";
    ...
    if ([wordNameForString isEqualToString:@"9. throw"]) {
        self.readWord = @"throw";
    ...
    if ([wordNameForString isEqualToString:@"9. wave"]) {
        self.readWord = @"wave";
    ...
    if ([wordNameForString isEqualToString:@"10. benefit"]) {
        self.readWord = @"benefit";
    ...
    if ([wordNameForString isEqualToString:@"10. certain"]) {
        self.readWord = @"certain";
    ...
    if ([wordNameForString isEqualToString:@"10. chance"]) {
        self.readWord = @"chance";
    ...
    if ([wordNameForString isEqualToString:@"10. effect"]) {
        self.readWord = @"effect";
        ewTextView.text =  @"名詞 複～s/-ts/\n影響, 効果; 効用, 効能, ききめ\nThe aspirins soon took effect.\nアスピリンはすぐに効いた。\n\n効果, 装置; エフェクト; 印象, 雰囲気\n\n動詞～s/-ts/; ～ed/-ɪd/; ～ing\n他動詞\n結果をもたらす; 目的を成就する";
        [hatuonLabel setText:[NSString stringWithFormat:@"ɪfékt"]];
        reibun = @"The aspirins soon took effect.";
    }
    if ([wordNameForString isEqualToString:@"10. essential"]) {
        self.readWord = @"essential";
    ...
    if ([wordNameForString isEqualToString:@"10. far"]) {
        self.readWord = @"far";
    ...
    if ([wordNameForString isEqualToString:@"10. focus"]) {
        self.readWord = @"focus";
    ...
    if ([wordNameForString isEqualToString:@"10. function"]) {
    ...
    if ([wordNameForString isEqualToString:@"10. grass"]) {
        self.readWord = @"grass";
        ewTextView.text =  @"名詞 複～es/-ɪz/\n草, 牧草; 芝\n\n草地, 牧草地;芝生, 芝地";
        [hatuonLabel setText:[NSString stringWithFormat:@"ɡræs|ɡrɑːs"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"10. guard"]) {
        self.readWord = @"guard";
    ...
    if ([wordNameForString isEqualToString:@"10. image"]) {
        self.readWord = @"image";
    ...
    if ([wordNameForString isEqualToString:@"10. immediate"]) {
        self.readWord = @"immediate";
    ...
    if ([wordNameForString isEqualToString:@"10. primary"]) {
        self.readWord = @"primary";
    ...
    if ([wordNameForString isEqualToString:@"10. proud"]) {
        self.readWord = @"proud";
    ...
    if ([wordNameForString isEqualToString:@"10. remain"]) {
        self.readWord = @"remain";
    ...
    if ([wordNameForString isEqualToString:@"10. rest"]) {
        self.readWord = @"rest";
    ...
    if ([wordNameForString isEqualToString:@"10. separate"]) {
        self.readWord = @"separate";
    ...
    if ([wordNameForString isEqualToString:@"11. anymore"]) {
        self.readWord = @"anymore";
        ewTextView.text =  @"もはや, これ以上\nDon't waste my time anymore.\nこれ以上私の時間を無駄にしないで。";
        [hatuonLabel setText:[NSString stringWithFormat:@"ènimɔ'ːr"]];
        reibun = @"Don't waste my time anymore.";
    }
    if ([wordNameForString isEqualToString:@"11. asleep"]) {
        self.readWord = @"asleep";
    ...
    if ([wordNameForString isEqualToString:@"11. berry"]) {
        self.readWord = @"berry";
        ewTextView.text =  @"名詞 複-ries/-z/\nベリー";
        [hatuonLabel setText:[NSString stringWithFormat:@"béri"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"11. collect"]) {
        self.readWord = @"collect";
    ...
    if ([wordNameForString isEqualToString:@"11. compete"]) {
        self.readWord = @"compete";
    ...
    if ([wordNameForString isEqualToString:@"11. conversation"]) {
        self.readWord = @"conversation";
        ewTextView.text =  @"名詞 複～s/-z/\n会話, おしゃべり, 対話, 座談, 雑談\nI listened to their conversation.\n彼らの会話を聞いた。";
        [hatuonLabel setText:[NSString stringWithFormat:@"kɑ̀nvərséɪʃ(ə)n|kɔ̀n-"]];
        reibun = @"I listened to their conversation.";
    }
    if ([wordNameForString isEqualToString:@"11. creature"]) {
        self.readWord = @"creature";
    ...
    if ([wordNameForString isEqualToString:@"11. decision"]) {
        self.readWord = @"decision";
    ...
    if ([wordNameForString isEqualToString:@"11. either"]) {
        self.readWord = @"either";
    ...
    if ([wordNameForString isEqualToString:@"11. forest"]) {
        self.readWord = @"forest";
        ewTextView.text =  @"名詞 複～s/-ts/\n森林, 山林;森林;森の, 森に住む\n\n動詞\n他動詞\n…に植林する; …を木々で覆う[森林化する].";
        [hatuonLabel setText:[NSString stringWithFormat:@"fɔ́ːrəst"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"11. ground"]) {
        self.readWord = @"ground";
    ...
    if ([wordNameForString isEqualToString:@"11. introduce"]) {
        self.readWord = @"introduce";
    ...
    if ([wordNameForString isEqualToString:@"11. marry"]) {
        self.readWord = @"marry";
    ...
    if ([wordNameForString isEqualToString:@"11. prepare"]) {
        self.readWord = @"prepare";
    ...
    if ([wordNameForString isEqualToString:@"11. sail"]) {
        self.readWord = @"sail";
    ...
    if ([wordNameForString isEqualToString:@"11. serious"]) {
        self.readWord = @"serious";
    ...
    if ([wordNameForString isEqualToString:@"11. spend"]) {
        self.readWord = @"spend";
    ...
    if ([wordNameForString isEqualToString:@"11. strange"]) {
        self.readWord = @"strange";
    ...
    if ([wordNameForString isEqualToString:@"12. alone"]) {
        self.readWord = @"alone";
        ewTextView.text =  @"形容詞\nたったひとりだ, 自分(たち)だけだ\nI was alone in the classroom.\n教室でたった一人だった。\n\n孤独だ; 身寄り[知り合い]がない\n\n他に匹敵[比較]するものがない\n\n~のみ\n\n副詞\n一人で, 単身[単独]で; ~だけで, 独力で";
        [hatuonLabel setText:[NSString stringWithFormat:@"əlóʊn"]];
        reibun = @"I was alone in the classroom.";
    }
    if ([wordNameForString isEqualToString:@"12. apartment"]) {
        self.readWord = @"apartment";
    ...
    if ([wordNameForString isEqualToString:@"12. article"]) {
        self.readWord = @"article";
    ...
    if ([wordNameForString isEqualToString:@"12. artist"]) {
        self.readWord = @"artist";
        ewTextView.text =  @"名詞 複～s/-ts/\n芸術家\n\n絵のうまい人\n\n達人, 名人, 通";
        [hatuonLabel setText:[NSString stringWithFormat:@"ɑ́ːrtəst"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"12. attitude"]) {
        self.readWord = @"attitude";
    ...
    if ([wordNameForString isEqualToString:@"12. compare"]) {
        self.readWord = @"compare";
    ...
    if ([wordNameForString isEqualToString:@"12. judge"]) {
        self.readWord = @"judge";
    ...
    if ([wordNameForString isEqualToString:@"12. magazine"]) {
        self.readWord = @"magazine";
        ewTextView.text =  @"名詞 複～s/-z/\n雑誌, 定期刊行物\n\n雑誌の";
        [hatuonLabel setText:[NSString stringWithFormat:@"mǽɡəzìːn"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"12. material"]) {
        self.readWord = @"material";
    ...
    if ([wordNameForString isEqualToString:@"12. meal"]) {
        self.readWord = @"meal";
    ...
    if ([wordNameForString isEqualToString:@"12. method"]) {
        self.readWord = @"method";
        ewTextView.text =  @"名詞 複～s/-dz/\n方法, 方式\nI have a simple and easy method.\n私には簡単で手軽な方法がある。\n\n秩序, 順序; 筋道; きちょうめんなこと";
        [hatuonLabel setText:[NSString stringWithFormat:@"méθəd"]];
        reibun = @"I have a simple and easy method.";
    }
    if ([wordNameForString isEqualToString:@"12. neighbor"]) {
        self.readWord = @"neighbor";
    ...
    if ([wordNameForString isEqualToString:@"12. professional"]) {
        self.readWord = @"professional";
    ...
    if ([wordNameForString isEqualToString:@"12. profit"]) {
        self.readWord = @"profit";
    ...
    if ([wordNameForString isEqualToString:@"12. quality"]) {
        self.readWord = @"quality";
    ...
    if ([wordNameForString isEqualToString:@"12. shape"]) {
        self.readWord = @"shape";
    ...
    if ([wordNameForString isEqualToString:@"12. space"]) {
        self.readWord = @"space";
    ...
    if ([wordNameForString isEqualToString:@"12. stair"]) {
        self.readWord = @"stair";
    ...
    if ([wordNameForString isEqualToString:@"12. symbol"]) {
        self.readWord = @"symbol";
        ewTextView.text =  @"名詞 複～s/-z/\n象徴, 表象, シンボル\nThe dove is the symbol of peace.\n鳩は平和の象徴だ。\n\n記号, 符号";
        [hatuonLabel setText:[NSString stringWithFormat:@"sɪ́mb(ə)l"]];
        reibun = @"The dove is the symbol of peace.";
    }
    if ([wordNameForString isEqualToString:@"12. thin"]) {
        self.readWord = @"thin";
    ...
    if ([wordNameForString isEqualToString:@"13. blood"]) {
        self.readWord = @"blood";
        ewTextView.text =  @"名詞\n血, 血液\n\n血統, 家系\n\n体液; 樹液\n\n流血, 暴力\n\n血気, 情熱";
        [hatuonLabel setText:[NSString stringWithFormat:@"blʌd"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"13. burn"]) {
        self.readWord = @"burn";
    ...
    if ([wordNameForString isEqualToString:@"13. cell"]) {
        self.readWord = @"cell";
    ...
    if ([wordNameForString isEqualToString:@"13. contain"]) {
        self.readWord = @"contain";
    ...
    if ([wordNameForString isEqualToString:@"13. correct"]) {
        self.readWord = @"correct";
    ...
    if ([wordNameForString isEqualToString:@"13. crop"]) {
        self.readWord = @"crop";
        ewTextView.text =  @"名詞 複～s/-s/\n作物, 農産物\nThe flood did a lot of damage to the crops.\nその洪水は農作物に大きな被害を与えた。\n\n収穫高, 作柄; 生産高\n\n続出する~; ~の集まり\n\n動詞～s/-s/; ～ped/-t/; ～ping\n他動詞\n~を短く切る; ~を刈って~にする\n\n~を切り落とす;不要な部分を切る\n\n自動詞\n作物ができる, 取れる";
        [hatuonLabel setText:[NSString stringWithFormat:@"krɑp|krɔp"]];
        reibun = @"The flood did a lot of damage to the crops.";
    }
    if ([wordNameForString isEqualToString:@"13. demand"]) {
        self.readWord = @"demand";
    ...
    if ([wordNameForString isEqualToString:@"13. equal"]) {
        self.readWord = @"equal";
    ...
    if ([wordNameForString isEqualToString:@"13. feed"]) {
        self.readWord = @"feed";
    ...
    if ([wordNameForString isEqualToString:@"13. hole"]) {
        self.readWord = @"hole";
        ewTextView.text =  @"名詞 複～s/-z/\n穴; くぼみ; すき間, 破れ目\nThere is a hole in my sock.\n私の靴下に穴が開いている。\n\n巣穴, 隠れ家; 独房, 土牢\n\n苦境, 窮地; ~の空き, 時間のすき間\n\n欠点, 不備, 弱点\n\n他動詞\n~が穴があく";
        [hatuonLabel setText:[NSString stringWithFormat:@"hoʊl"]];
        reibun = @"There is a hole in my sock.";
    }
    if ([wordNameForString isEqualToString:@"13. increase"]) {
        self.readWord = @"increase";
    ...
    if ([wordNameForString isEqualToString:@"13. lord"]) {
        self.readWord = @"lord";
        ewTextView.text =  @"名詞 複～s/-dz/\n高位の貴族\n\n領主, 地主; 荘園主\n\n…長, 長官; …主教\n\n主, 神; キリスト";
        [hatuonLabel setText:[NSString stringWithFormat:@"lɔːrd"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"13. owe"]) {
        self.readWord = @"owe";
    ...
    if ([wordNameForString isEqualToString:@"13. position"]) {
        self.readWord = @"position";
    ...
    if ([wordNameForString isEqualToString:@"13. raise"]) {
        self.readWord = @"raise";
    ...
    if ([wordNameForString isEqualToString:@"13. responsible"]) {
        self.readWord = @"responsible";
    ...
    if ([wordNameForString isEqualToString:@"13. sight"]) {
        self.readWord = @"sight";
        ewTextView.text =  @"名詞複～s/-ts/\n視力, 視覚\n\n見る[見える]こと; 一見, 一瞥\n\n視野, 見える範囲, 視界\nThe train is still in sight.\nその列車がまだ見える。\n\n景色, 光景, 眺め \n\n名所, 見所\n\nねらい, 目標\n\n物笑いの種, ひどいもの\n\n多数[多量]の~";
        [hatuonLabel setText:[NSString stringWithFormat:@"saɪt"]];
        reibun = @"The train is still in sight.";
    }
    if ([wordNameForString isEqualToString:@"13. spot"]) {
        self.readWord = @"spot";
    ...
    if ([wordNameForString isEqualToString:@"13. structure"]) {
        self.readWord = @"structure";
    ...
    if ([wordNameForString isEqualToString:@"13. whole"]) {
        self.readWord = @"whole";
        ewTextView.text =  @"形容詞\n全体の~, 全部の~, まるごとの~\nThe whole country was anxious for peace.\n国中が平和を切望した。\n\n1つ丸ごとの; 丸~の期間, ~中\n\nたいへんな~, ものすごい~, 大事な~\n\n無傷で; 健康で\n\n名詞\n~全体, ~の全部\n\n統一体, 完全体\n\n副詞\n違いを強調して まったく";
        [hatuonLabel setText:[NSString stringWithFormat:@"hoʊl"]];
        reibun = @"The whole country was anxious for peace.";
    }
    if ([wordNameForString isEqualToString:@"14. coach"]) {
        self.readWord = @"coach";
    ...
    if ([wordNameForString isEqualToString:@"14. control"]) {
        self.readWord = @"control";
    ...
    if ([wordNameForString isEqualToString:@"14. description"]) {
        self.readWord = @"description";
    ...
    if ([wordNameForString isEqualToString:@"14. direct"]) {
        self.readWord = @"direct";
    ...
    if ([wordNameForString isEqualToString:@"14. exam"]) {
        self.readWord = @"exam";
    ...
    if ([wordNameForString isEqualToString:@"14. example"]) {
        self.readWord = @"example";
    ...
    if ([wordNameForString isEqualToString:@"14. limit"]) {
        self.readWord = @"limit";
    ...
    if ([wordNameForString isEqualToString:@"14. local"]) {
        self.readWord = @"local";
    ...
    if ([wordNameForString isEqualToString:@"14. magical"]) {
        self.readWord = @"magical";
    ...
    if ([wordNameForString isEqualToString:@"14. mail"]) {
        self.readWord = @"mail";
    ...
    if ([wordNameForString isEqualToString:@"14. novel"]) {
        self.readWord = @"novel";
        ewTextView.text =  @"名詞 複～s/-z/\n小説";
        [hatuonLabel setText:[NSString stringWithFormat:@"nɑ́v(ə)l|nɔ́v-"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"14. outline"]) {
        self.readWord = @"outline";
    ...
    if ([wordNameForString isEqualToString:@"14. poet"]) {
        self.readWord = @"poet";
        ewTextView.text =  @"名詞 複～s/-ts/\n詩人, 歌人; 詩的着想のある人";
        [hatuonLabel setText:[NSString stringWithFormat:@"póʊət"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"14. print"]) {
        self.readWord = @"print";
    ...
    if ([wordNameForString isEqualToString:@"14. scene"]) {
        self.readWord = @"scene";
    ...
    if ([wordNameForString isEqualToString:@"14. store"]) {
        self.readWord = @"store";
    ...
    if ([wordNameForString isEqualToString:@"14. suffer"]) {
        self.readWord = @"suffer";
    ...
    if ([wordNameForString isEqualToString:@"14. technology"]) {
        self.readWord = @"technology";
        ewTextView.text =  @"名詞 複-gies/-z/\n科学技術, テクノロジー; 工学, 応用科学; 技術的方法";
        [hatuonLabel setText:[NSString stringWithFormat:@"teknɑ́lədʒi|-nɔ́l-"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"15. across"]) {
        self.readWord = @"across";
    ...
    if ([wordNameForString isEqualToString:@"15. breathe"]) {
        self.readWord = @"breathe";
    ...
    if ([wordNameForString isEqualToString:@"15. characteristic"]) {
        self.readWord = @"characteristic";
    ...
    if ([wordNameForString isEqualToString:@"15. consume"]) {
        self.readWord = @"consume";
    ...
    if ([wordNameForString isEqualToString:@"15. excite"]) {
        self.readWord = @"excite";
    ...
    if ([wordNameForString isEqualToString:@"15. extreme"]) {
        self.readWord = @"extreme";
    ...
    if ([wordNameForString isEqualToString:@"15. fear"]) {
        self.readWord = @"fear";
    ...
    if ([wordNameForString isEqualToString:@"15. fortunate"]) {
        self.readWord = @"fortunate";
    ...
    if ([wordNameForString isEqualToString:@"15. happen"]) {
        self.readWord = @"happen";
    ...
    if ([wordNameForString isEqualToString:@"15. length"]) {
        self.readWord = @"length";
    ...
    if ([wordNameForString isEqualToString:@"15. mistake"]) {
        self.readWord = @"mistake";
    ...
    if ([wordNameForString isEqualToString:@"15. observe"]) {
        self.readWord = @"observe";
    ...
    if ([wordNameForString isEqualToString:@"15. opportunity"]) {
        self.readWord = @"opportunity";
    ...
    if ([wordNameForString isEqualToString:@"15. prize"]) {
        self.readWord = @"prize";
    ...
    if ([wordNameForString isEqualToString:@"15. race"]) {
        self.readWord = @"race";
    ...
    if ([wordNameForString isEqualToString:@"15. realize"]) {
        self.readWord = @"realize";
    ...
    if ([wordNameForString isEqualToString:@"15. respond"]) {
        self.readWord = @"respond";
    ...
    if ([wordNameForString isEqualToString:@"15. risk"]) {
        self.readWord = @"risk";
        ewTextView.text =  @"名詞 複～s/-s/\n恐れ, 危険, リスク\nHe saved my life at the risk of his own.\n彼は自分の危険を顧みずに私の命を救った。\n\n危険因子, 有害なもの\n\n被保険者[物]\n\n動詞\n他動詞\nを危険にさらす;を賭ける \n\nの危機に陥る; ~する恐れがある\n\n~をあえてする, 試みる; あえて~する";
        [hatuonLabel setText:[NSString stringWithFormat:@"rɪsk"]];
        reibun = @"He saved my life at the risk of his own.";
    }
    if ([wordNameForString isEqualToString:@"15. wonder"]) {
        self.readWord = @"wonder";
    ...
    if ([wordNameForString isEqualToString:@"15. yet"]) {
        self.readWord = @"yet";
    ...
    if ([wordNameForString isEqualToString:@"16. academy"]) {
        self.readWord = @"academy";
    ...
    if ([wordNameForString isEqualToString:@"16. ancient"]) {
        self.readWord = @"ancient";
    ...
    if ([wordNameForString isEqualToString:@"16. board"]) {
        self.readWord = @"board";
    ...
    if ([wordNameForString isEqualToString:@"16. century"]) {
        self.readWord = @"century";
    ...
    if ([wordNameForString isEqualToString:@"16. clue"]) {
        self.readWord = @"clue";
    ...
    if ([wordNameForString isEqualToString:@"16. concert"]) {
        self.readWord = @"concert";
    ...
    if ([wordNameForString isEqualToString:@"16. county"]) {
        self.readWord = @"county";
    ...
    if ([wordNameForString isEqualToString:@"16. dictionary"]) {
        self.readWord = @"dictionary";
        ewTextView.text =  @"名詞 複-ies/-z/\n辞書, 辞典, 字引\nHe is, as it were, a walking dictionary.\n彼はいわば生き字引だ。\n\n事典, 特殊辞典";
        [hatuonLabel setText:[NSString stringWithFormat:@"dɪ́kʃənèri|-ʃ(ə)n(ə)ri"]];
        reibun = @"He is, as it were, a walking dictionary.";
    }
    if ([wordNameForString isEqualToString:@"16. exist"]) {
        self.readWord = @"exist";
    ...
    if ([wordNameForString isEqualToString:@"16. flat"]) {
        self.readWord = @"flat";
    ...
    if ([wordNameForString isEqualToString:@"16. gentleman"]) {
        self.readWord = @"gentleman";
        ewTextView.text =  @"名詞 複-men/-mən/\n紳士\n\n丁寧に男の方, 殿方; 男の人\n\nみなさん\n\n男子トイレ\n\n男性議員";
        [hatuonLabel setText:[NSString stringWithFormat:@"dʒént(ə)lmən"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"16. hidden"]) {
        self.readWord = @"hidden";
    ...
    if ([wordNameForString isEqualToString:@"16. maybe"]) {
        self.readWord = @"maybe";
    ...
    if ([wordNameForString isEqualToString:@"16. officer"]) {
        self.readWord = @"officer";
    ...
    if ([wordNameForString isEqualToString:@"16. original"]) {
        self.readWord = @"original";
    ...
    if ([wordNameForString isEqualToString:@"16. pound"]) {
        self.readWord = @"pound";
    ...
    if ([wordNameForString isEqualToString:@"16. process"]) {
        self.readWord = @"process";
    ...
    if ([wordNameForString isEqualToString:@"16. publish"]) {
        self.readWord = @"publish";
    ...
    if ([wordNameForString isEqualToString:@"16. theater"]) {
        self.readWord = @"theater";
    ...
    if ([wordNameForString isEqualToString:@"16. wealth"]) {
        self.readWord = @"wealth";
    ...
    if ([wordNameForString isEqualToString:@"17. appreciate"]) {
        self.readWord = @"appreciate";
    ...
    if ([wordNameForString isEqualToString:@"17. available"]) {
        self.readWord = @"available";
    ...
    if ([wordNameForString isEqualToString:@"17. beat"]) {
        self.readWord = @"beat";
    ...
    if ([wordNameForString isEqualToString:@"17. bright"]) {
        self.readWord = @"bright";
    ...
    if ([wordNameForString isEqualToString:@"17. celebrate"]) {
        self.readWord = @"celebrate";
    ...
    if ([wordNameForString isEqualToString:@"17. determine"]) {
        self.readWord = @"determine";
    ...
    if ([wordNameForString isEqualToString:@"17. disappear"]) {
        self.readWord = @"disappear";
    ...
    if ([wordNameForString isEqualToString:@"17. flow"]) {
        self.readWord = @"flow";
    ...
    if ([wordNameForString isEqualToString:@"17. forward"]) {
        self.readWord = @"forward";
    ...
    if ([wordNameForString isEqualToString:@"17. hill"]) {
        self.readWord = @"hill";
        ewTextView.text =  @"名詞 複～s/-z/\n丘, 小山; 丘陵地帯\n\n坂, 斜面\n\n米国議会\n\n塚; 山状のもの";
        [hatuonLabel setText:[NSString stringWithFormat:@"hɪl"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"17. level"]) {
        self.readWord = @"level";
    ...
    if ([wordNameForString isEqualToString:@"17. lone"]) {
        self.readWord = @"lone";
    ...
    if ([wordNameForString isEqualToString:@"17. puddle"]) {
        self.readWord = @"puddle";
    ...
    if ([wordNameForString isEqualToString:@"17. response"]) {
        self.readWord = @"response";
    ...
    if ([wordNameForString isEqualToString:@"17. season"]) {
        self.readWord = @"season";
    ...
    if ([wordNameForString isEqualToString:@"17. solution"]) {
        self.readWord = @"solution";
    ...
    if ([wordNameForString isEqualToString:@"17. waste"]) {
        self.readWord = @"waste";
    ...
    if ([wordNameForString isEqualToString:@"17. whether"]) {
        self.readWord = @"whether";
    ...
    if ([wordNameForString isEqualToString:@"18. argue"]) {
        self.readWord = @"argue";
    ...
    if ([wordNameForString isEqualToString:@"18. communicate"]) {
        self.readWord = @"communicate";
    ...
    if ([wordNameForString isEqualToString:@"18. crowd"]) {
        self.readWord = @"crowd";
    ...
    if ([wordNameForString isEqualToString:@"18. depend"]) {
        self.readWord = @"depend";
    ...
    if ([wordNameForString isEqualToString:@"18. dish"]) {
        self.readWord = @"dish";
    ...
    if ([wordNameForString isEqualToString:@"18. empty"]) {
        self.readWord = @"empty";
    ...
    if ([wordNameForString isEqualToString:@"18. exact"]) {
        self.readWord = @"exact";
    ...
    if ([wordNameForString isEqualToString:@"18. fresh"]) {
        self.readWord = @"fresh";
    ...
    if ([wordNameForString isEqualToString:@"18. gather"]) {
        self.readWord = @"gather";
    ...
    if ([wordNameForString isEqualToString:@"18. indicate"]) {
        self.readWord = @"indicate";
    ...
    if ([wordNameForString isEqualToString:@"18. item"]) {
        self.readWord = @"item";
    ...
    if ([wordNameForString isEqualToString:@"18. offer"]) {
        self.readWord = @"offer";
    ...
    if ([wordNameForString isEqualToString:@"18. price"]) {
        self.readWord = @"price";
    ...
    if ([wordNameForString isEqualToString:@"18. product"]) {
        self.readWord = @"product";
    ...
    if ([wordNameForString isEqualToString:@"18. property"]) {
        self.readWord = @"property";
    ...
    if ([wordNameForString isEqualToString:@"18. purchase"]) {
        self.readWord = @"purchase";
    ...
    if ([wordNameForString isEqualToString:@"18. recommend"]) {
        self.readWord = @"recommend";
    ...
    if ([wordNameForString isEqualToString:@"18. select"]) {
        self.readWord = @"select";
    ...
    if ([wordNameForString isEqualToString:@"18. tool"]) {
        self.readWord = @"tool";
    ...
    if ([wordNameForString isEqualToString:@"18. treat"]) {
        self.readWord = @"treat";
    ...
    if ([wordNameForString isEqualToString:@"19. alive"]) {
        self.readWord = @"alive";
    ...
    if ([wordNameForString isEqualToString:@"19. bone"]) {
        self.readWord = @"bone";
        ewTextView.text =  @"名詞 複～s/-z/\n骨\n\n骨格, 体つき; 骨子, 要点, 骨組み\n\n遺骨, 死体\n\n骨状のもの, 骨の役目をするもの\n\n副詞\nまったく, すっかり";
        [hatuonLabel setText:[NSString stringWithFormat:@"boʊn"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"19. bother"]) {
        self.readWord = @"bother";
    ...
    if ([wordNameForString isEqualToString:@"19. captain"]) {
        self.readWord = @"captain";
        ewTextView.text =  @"名詞 複～s/-z/\n船長, 艦長; 機長\n\nキャプテン, 主将; 工場の現地主任, 学級の級長\n\n集団の長; 指導者, 指揮者\n\n陸軍大尉 ; 海軍大佐; 空軍[海兵隊]大尉";
        [hatuonLabel setText:[NSString stringWithFormat:@"kǽpt(ə)n|-tɪn"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"19. conclusion"]) {
        self.readWord = @"conclusion";
    ...
    if ([wordNameForString isEqualToString:@"19. doubt"]) {
        self.readWord = @"doubt";
    ...
    if ([wordNameForString isEqualToString:@"19. explore"]) {
        self.readWord = @"explore";
    ...
    if ([wordNameForString isEqualToString:@"19. foreign"]) {
        self.readWord = @"foreign";
    ...
    if ([wordNameForString isEqualToString:@"19. glad"]) {
        self.readWord = @"glad";
    ...
    if ([wordNameForString isEqualToString:@"19. however"]) {
        self.readWord = @"however";
    ...
    if ([wordNameForString isEqualToString:@"19. injustice"]) {
        self.readWord = @"injustice";
    ...
    if ([wordNameForString isEqualToString:@"19. international"]) {
        self.readWord = @"international";
    ...
    if ([wordNameForString isEqualToString:@"19. lawyer"]) {
        self.readWord = @"lawyer";
        ewTextView.text =  @"名詞 複～s/-z/\n法律家, 弁護士; 法律通";
        [hatuonLabel setText:[NSString stringWithFormat:@"lɔ́ːjər, lɔ́ɪər"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"19. mention"]) {
        self.readWord = @"mention";
    ...
    if ([wordNameForString isEqualToString:@"19. policy"]) {
        self.readWord = @"policy";
    ...
    if ([wordNameForString isEqualToString:@"19. social"]) {
        self.readWord = @"social";
    ...
    if ([wordNameForString isEqualToString:@"19. speech"]) {
        self.readWord = @"speech";
    ...
    if ([wordNameForString isEqualToString:@"19. staff"]) {
        self.readWord = @"staff";
        ewTextView.text =  @"名詞 複～s/-s/\n職員, 従業員, 社員, スタッフ\n\n動詞～s/-s/; ～ed/-t/; ～ing\n他動詞\n職場、会社が 職員[スタッフ]を配置されている ; ~のスタッフを務める";
        [hatuonLabel setText:[NSString stringWithFormat:@"stæf|stɑːf"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"19. toward"]) {
        self.readWord = @"toward";
    ...
    if ([wordNameForString isEqualToString:@"19. wood"]) {
        self.readWord = @"wood";
        ewTextView.text =  @"名詞 複～s/-dz/\n木材, 材料としての木; 木製の\n\n森; 林\n\nまき, 薪";
        [hatuonLabel setText:[NSString stringWithFormat:@"wʊd"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"20. achieve"]) {
        self.readWord = @"achieve";
    ...
    if ([wordNameForString isEqualToString:@"20. advise"]) {
        self.readWord = @"advise";
    ...
    if ([wordNameForString isEqualToString:@"20. already"]) {
        self.readWord = @"already";
    ...
    if ([wordNameForString isEqualToString:@"20. basic"]) {
        self.readWord = @"basic";
    ...
    if ([wordNameForString isEqualToString:@"20. bit"]) {
        self.readWord = @"bit";
    ...
    if ([wordNameForString isEqualToString:@"20. consider"]) {
        self.readWord = @"consider";
    ...
    if ([wordNameForString isEqualToString:@"20. destroy"]) {
        self.readWord = @"destroy";
    ...
    if ([wordNameForString isEqualToString:@"20. entertain"]) {
        self.readWord = @"entertain";
    ...
    if ([wordNameForString isEqualToString:@"20. extra"]) {
        self.readWord = @"extra";
    ...
    if ([wordNameForString isEqualToString:@"20. reflect"]) {
        self.readWord = @"reflect";
    ...
    if ([wordNameForString isEqualToString:@"20. regard"]) {
        self.readWord = @"regard";
    ...
    if ([wordNameForString isEqualToString:@"20. serve"]) {
        self.readWord = @"serve";
    ...
    if ([wordNameForString isEqualToString:@"20. vegetable"]) {
        self.readWord = @"vegetable";
        ewTextView.text =  @"名詞 複～s/-z/\n野菜; 温野菜\n\n植物, 草木\n\n形容詞\n野菜の; 植物性の";
        [hatuonLabel setText:[NSString stringWithFormat:@"védʒ(ə)təb(ə)l"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"20. war"]) {
        self.readWord = @"war";
    ...
    if ([wordNameForString isEqualToString:@"20. worth"]) {
        self.readWord = @"worth";
    ...
    if ([wordNameForString isEqualToString:@"21. appear"]) {
        self.readWord = @"appear";
    ...
    if ([wordNameForString isEqualToString:@"21. base"]) {
        self.readWord = @"base";
    ...
    if ([wordNameForString isEqualToString:@"21. brain"]) {
        self.readWord = @"brain";
    ...
    if ([wordNameForString isEqualToString:@"21. career"]) {
        self.readWord = @"career";
    ...
    if ([wordNameForString isEqualToString:@"21. clerk"]) {
        self.readWord = @"clerk";
    ...
    if ([wordNameForString isEqualToString:@"21. effort"]) {
        self.readWord = @"effort";
    ...
    if ([wordNameForString isEqualToString:@"21. enter"]) {
        self.readWord = @"enter";
    ...
    if ([wordNameForString isEqualToString:@"21. excellent"]) {
        self.readWord = @"excellent";
    ...
    if ([wordNameForString isEqualToString:@"21. hero"]) {
        self.readWord = @"hero";
        ewTextView.text =  @"名詞 複～es/-z/\n英雄, ヒーロー\n\n男性の主人公\n\nあこがれの対象";
        [hatuonLabel setText:[NSString stringWithFormat:@"híːroʊ, hɪ́r-|hɪ́ər-"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"21. hurry"]) {
        self.readWord = @"hurry";
    ...
    if ([wordNameForString isEqualToString:@"21. inform"]) {
        self.readWord = @"inform";
    ...
    if ([wordNameForString isEqualToString:@"21. locate"]) {
        self.readWord = @"locate";
    ...
    if ([wordNameForString isEqualToString:@"21. nurse"]) {
        self.readWord = @"nurse";
    ...
    if ([wordNameForString isEqualToString:@"21. operation"]) {
        self.readWord = @"operation";
    ...
    if ([wordNameForString isEqualToString:@"21. pain"]) {
        self.readWord = @"pain";
        ewTextView.text =  @"名詞 複～s/-z/\n痛み, 苦痛\nHe has a pain in the knee.\n彼は膝が痛い。\n\n苦しみ, 苦痛, 悩み, 苦悩\n\n骨折り, 苦労, 努力\n\nやっかいな~\n\n~を悲しくさせる, つらくさせる";
        [hatuonLabel setText:[NSString stringWithFormat:@"peɪn"]];
        reibun = @"He has a pain in the knee.";
    }
    if ([wordNameForString isEqualToString:@"21. refuse"]) {
        self.readWord = @"refuse";
    ...
    if ([wordNameForString isEqualToString:@"21. though"]) {
        self.readWord = @"though";
    ...
    if ([wordNameForString isEqualToString:@"21. various"]) {
        self.readWord = @"various";
    ...
    if ([wordNameForString isEqualToString:@"22. actual"]) {
        self.readWord = @"actual";
    ...
    if ([wordNameForString isEqualToString:@"22. amaze"]) {
        self.readWord = @"amaze";
    ...
    if ([wordNameForString isEqualToString:@"22. charge"]) {
        self.readWord = @"charge";
    ...
    if ([wordNameForString isEqualToString:@"22. comfort"]) {
        self.readWord = @"comfort";
    ...
    if ([wordNameForString isEqualToString:@"22. contact"]) {
        self.readWord = @"contact";
    ...
    if ([wordNameForString isEqualToString:@"22. customer"]) {
        self.readWord = @"customer";
    ...
    if ([wordNameForString isEqualToString:@"22. deliver"]) {
        self.readWord = @"deliver";
    ...
    if ([wordNameForString isEqualToString:@"22. earn"]) {
        self.readWord = @"earn";
    ...
    if ([wordNameForString isEqualToString:@"22. gate"]) {
        self.readWord = @"gate";
        ewTextView.text =  @"名詞 複～s/-ts/\n門, 通用門, 出入口; 扉; 道, 手段\nThe gate is too narrow for a car.\nその門は車が通るには狭すぎる。\n\n搭乗口, ゲート\n\n解雇, 拒絶";
        [hatuonLabel setText:[NSString stringWithFormat:@"ɡeɪt"]];
        reibun = @"The gate is too narrow for a car.";
    }
    if ([wordNameForString isEqualToString:@"22. include"]) {
        self.readWord = @"include";
    ...
    if ([wordNameForString isEqualToString:@"22. manage"]) {
        self.readWord = @"manage";
    ...
    if ([wordNameForString isEqualToString:@"22. mystery"]) {
        self.readWord = @"mystery";
    ...
    if ([wordNameForString isEqualToString:@"22. occur"]) {
        self.readWord = @"occur";
    ...
    if ([wordNameForString isEqualToString:@"22. opposite"]) {
        self.readWord = @"opposite";
    ...
    if ([wordNameForString isEqualToString:@"22. plate"]) {
        self.readWord = @"plate";
    ...
    if ([wordNameForString isEqualToString:@"22. receive"]) {
        self.readWord = @"receive";
    ...
    if ([wordNameForString isEqualToString:@"22. reward"]) {
        self.readWord = @"reward";
    ...
    if ([wordNameForString isEqualToString:@"22. set"]) {
        self.readWord = @"set";
    ...
    if ([wordNameForString isEqualToString:@"22. steal"]) {
        self.readWord = @"steal";
    ...
    if ([wordNameForString isEqualToString:@"22. thief"]) {
        self.readWord = @"thief";
    ...
    if ([wordNameForString isEqualToString:@"23. advance"]) {
        self.readWord = @"advance";
    ...
    if ([wordNameForString isEqualToString:@"23. athlete"]) {
        self.readWord = @"athlete";
    ...
    if ([wordNameForString isEqualToString:@"23. average"]) {
        self.readWord = @"average";
    ...
    if ([wordNameForString isEqualToString:@"23. behavior"]) {
        self.readWord = @"behavior";
    ...
    if ([wordNameForString isEqualToString:@"23. behind"]) {
        self.readWord = @"behind";
    ...
    if ([wordNameForString isEqualToString:@"23. match"]) {
        self.readWord = @"match";
    ...
    if ([wordNameForString isEqualToString:@"23. member"]) {
        self.readWord = @"member";
    ...
    if ([wordNameForString isEqualToString:@"23. mental"]) {
        self.readWord = @"mental";
    ...
    if ([wordNameForString isEqualToString:@"23. passenger"]) {
        self.readWord = @"passenger";
    ...
    if ([wordNameForString isEqualToString:@"23. personality"]) {
        self.readWord = @"personality";
    ...
    if ([wordNameForString isEqualToString:@"23. poem"]) {
        self.readWord = @"poem";
        ewTextView.text =  @"名詞 複～s/-z/\n詩, 詩歌";
        [hatuonLabel setText:[NSString stringWithFormat:@"póʊəm"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"23. pole"]) {
        self.readWord = @"pole";
    ...
    if ([wordNameForString isEqualToString:@"23. remove"]) {
        self.readWord = @"remove";
    ...
    if ([wordNameForString isEqualToString:@"23. safety"]) {
        self.readWord = @"safety";
    ...
    if ([wordNameForString isEqualToString:@"23. shoot"]) {
        self.readWord = @"shoot";
    ...
    if ([wordNameForString isEqualToString:@"23. sound"]) {
        self.readWord = @"sound";
    ...
    if ([wordNameForString isEqualToString:@"24. block"]) {
        self.readWord = @"block";
    ...
    if ([wordNameForString isEqualToString:@"24. cheer"]) {
        self.readWord = @"cheer";
    ...
    if ([wordNameForString isEqualToString:@"24. complex"]) {
        self.readWord = @"complex";
        ewTextView.text =  @"形容詞more ～; most ～\n複雑な, 複雑で理解しづらい, 込み入った\nIt was a complex problem.\nこれは複雑な問題だった。\n\n複合的な, 多くの部分から成る\n\n名詞 複～es/-ɪz/\n複合[大型]ビル; ビル群\n\nコンプレックス; 固定観念, 強迫観念 ";
        [hatuonLabel setText:[NSString stringWithFormat:@"kɑ̀mpléks|kɔ́mpleks"]];
        reibun = @"It was a complex problem.";
    }
    if ([wordNameForString isEqualToString:@"24. critic"]) {
        self.readWord = @"critic";
    ...
    if ([wordNameForString isEqualToString:@"24. event"]) {
        self.readWord = @"event";
    ...
    if ([wordNameForString isEqualToString:@"24. exercise"]) {
        self.readWord = @"exercise";
    ...
    if ([wordNameForString isEqualToString:@"24. fit"]) {
        self.readWord = @"fit";
    ...
    if ([wordNameForString isEqualToString:@"24. friendship"]) {
        self.readWord = @"friendship";
        ewTextView.text =  @"名詞 複～s/-s/\n友人関係, 友達付き合い\n\n友情, 親睦\nReal friendship is more valuable than money.\n本物の友情は金銭より大切だ。\n\n友好関係";
        [hatuonLabel setText:[NSString stringWithFormat:@"frén(d)ʃɪ̀p"]];
        reibun = @"Real friendship is more valuable than money.";
    }
    if ([wordNameForString isEqualToString:@"24. guide"]) {
        self.readWord = @"guide";
    ...
    if ([wordNameForString isEqualToString:@"24. lack"]) {
        self.readWord = @"lack";
    ...
    if ([wordNameForString isEqualToString:@"24. passage"]) {
        self.readWord = @"passage";
        ewTextView.text =  @"名詞 複～s/-ɪz/\n通路, 通り道; 出入口, ホール\nWe discovered a secret passage behind the wall.\n壁の後ろに秘密通路を発見した。\n\n通行許可; 抜け道, 行く手\n\n一節; 一句; 引用部\n\n通過, 可決\n\n発展, 成長, 進歩\n\n体内で気体、液体が通る管";
        [hatuonLabel setText:[NSString stringWithFormat:@"pǽsɪdʒ"]];
        reibun = @"We discovered a secret passage behind the wall.";
    }
    if ([wordNameForString isEqualToString:@"24. perform"]) {
        self.readWord = @"perform";
    ...
    if ([wordNameForString isEqualToString:@"24. pressure"]) {
        self.readWord = @"pressure";
    ...
    if ([wordNameForString isEqualToString:@"24. probable"]) {
        self.readWord = @"probable";
    ...
    if ([wordNameForString isEqualToString:@"24. public"]) {
        self.readWord = @"public";
    ...
    if ([wordNameForString isEqualToString:@"24. strike"]) {
        self.readWord = @"strike";
    ...
    if ([wordNameForString isEqualToString:@"24. support"]) {
        self.readWord = @"support";
    ...
    if ([wordNameForString isEqualToString:@"24. unite"]) {
        self.readWord = @"unite";
    ...
    if ([wordNameForString isEqualToString:@"25. associate"]) {
        self.readWord = @"associate";
    ...
    if ([wordNameForString isEqualToString:@"25. environment"]) {
        self.readWord = @"environment";
    ...
    if ([wordNameForString isEqualToString:@"25. factory"]) {
        self.readWord = @"factory";
    ...
    if ([wordNameForString isEqualToString:@"25. feature"]) {
        self.readWord = @"feature";
    ...
    if ([wordNameForString isEqualToString:@"25. instance"]) {
        self.readWord = @"instance";
        ewTextView.text =  @"名詞 複～s/-ɪz/\n例, 実例, 例証; 特定の場合\nThis is only one instance out of many.\nこれは数多くある実例の一つに過ぎない。";
        [hatuonLabel setText:[NSString stringWithFormat:@"ɪ́nst(ə)ns"]];
        reibun = @"This is only one instance out of many.";
    }
    if ([wordNameForString isEqualToString:@"25. involve"]) {
        self.readWord = @"involve";
    ...
    if ([wordNameForString isEqualToString:@"25. medicine"]) {
        self.readWord = @"medicine";
    ...
    if ([wordNameForString isEqualToString:@"25. mix"]) {
        self.readWord = @"mix";
    ...
    if ([wordNameForString isEqualToString:@"25. organize"]) {
        self.readWord = @"organize";
    ...
    if ([wordNameForString isEqualToString:@"25. period"]) {
        self.readWord = @"period";
        ewTextView.text =  @"名詞 複～s/-dz/\n期間, 時期; ~期間\nChildhood is a period of rapid growth.\n幼年期は成長が早い時期だ。\n\n発達時期[段階, 過程]/ 病気の潜伏期\n\n時代\n\n月経期間[周期]\n\n時間, 時限\n\n終止符, ピリオド\n\n終わり";
        [hatuonLabel setText:[NSString stringWithFormat:@"píəriəd"]];
        reibun = @"Childhood is a period of rapid growth.";
    }
    if ([wordNameForString isEqualToString:@"25. populate"]) {
        self.readWord = @"populate";
    ...
    if ([wordNameForString isEqualToString:@"25. produce"]) {
        self.readWord = @"produce";
    ...
    if ([wordNameForString isEqualToString:@"25. range"]) {
        self.readWord = @"range";
    ...
    if ([wordNameForString isEqualToString:@"25. recognize"]) {
        self.readWord = @"recognize";
    ...
    if ([wordNameForString isEqualToString:@"25. regular"]) {
        self.readWord = @"regular";
    ...
    if ([wordNameForString isEqualToString:@"25. sign"]) {
        self.readWord = @"sign";
    ...
    if ([wordNameForString isEqualToString:@"25. trash"]) {
        self.readWord = @"trash";
    ...
    if ([wordNameForString isEqualToString:@"25. wide"]) {
        self.readWord = @"wide";
    ...
    if ([wordNameForString isEqualToString:@"26. advice"]) {
        self.readWord = @"advice";
    ...
    if ([wordNameForString isEqualToString:@"26. along"]) {
        self.readWord = @"along";
        ewTextView.text =  @"前置詞\n~に沿って, ~づたいに, 端から端へ~をずっと\nWe walked along the road.\n私達はその道に沿って歩いた。\n\n~に沿って行ったところに; ~の途中に\n\n~に沿ってずっと\n\n方針、やり方に従って, 沿って\n\n副詞\n先へ, 前方へ, どんどん; 人から人へ\n\n連れて; 携えて\n\n(時間が)進んで; はかどって, 順調で\n\n沿って; ~の後ろについて";
        [hatuonLabel setText:[NSString stringWithFormat:@"əlɔ́ːŋ|əlɔ́ŋ"]];
        reibun = @"We walked along the road.";
    }
    if ([wordNameForString isEqualToString:@"26. attention"]) {
        self.readWord = @"attention";
    ...
    if ([wordNameForString isEqualToString:@"26. attract"]) {
        self.readWord = @"attract";
    ...
    if ([wordNameForString isEqualToString:@"26. climb"]) {
        self.readWord = @"climb";
    ...
    if ([wordNameForString isEqualToString:@"26. drop"]) {
        self.readWord = @"drop";
    ...
    if ([wordNameForString isEqualToString:@"26. final"]) {
        self.readWord = @"final";
    ...
    if ([wordNameForString isEqualToString:@"26. further"]) {
        self.readWord = @"further";
    ...
    if ([wordNameForString isEqualToString:@"26. maintain"]) {
        self.readWord = @"maintain";
    ...
    if ([wordNameForString isEqualToString:@"26. neither"]) {
        self.readWord = @"neither";
    ...
    if ([wordNameForString isEqualToString:@"26. otherwise"]) {
        self.readWord = @"otherwise";
    ...
    if ([wordNameForString isEqualToString:@"26. physical"]) {
        self.readWord = @"physical";
    ...
    if ([wordNameForString isEqualToString:@"26. prove"]) {
        self.readWord = @"prove";
    ...
    if ([wordNameForString isEqualToString:@"26. react"]) {
        self.readWord = @"react";
    ...
    if ([wordNameForString isEqualToString:@"26. ride"]) {
        self.readWord = @"ride";
    ...
    if ([wordNameForString isEqualToString:@"26. situated"]) {
        self.readWord = @"situated";
    ...
    if ([wordNameForString isEqualToString:@"26. society"]) {
        self.readWord = @"society";
    ...
    if ([wordNameForString isEqualToString:@"26. standard"]) {
        self.readWord = @"standard";
    ...
    if ([wordNameForString isEqualToString:@"26. suggest"]) {
        self.readWord = @"suggest";
    ...
    if ([wordNameForString isEqualToString:@"27. actually"]) {
        self.readWord = @"actually";
    ...
    if ([wordNameForString isEqualToString:@"27. bite"]) {
        self.readWord = @"bite";
    ...
    if ([wordNameForString isEqualToString:@"27. coast"]) {
        self.readWord = @"coast";
    ...
    if ([wordNameForString isEqualToString:@"27. deal"]) {
        self.readWord = @"deal";
    ...
    if ([wordNameForString isEqualToString:@"27. desert"]) {
        self.readWord = @"desert";
    ...
    if ([wordNameForString isEqualToString:@"27. earthquake"]) {
        self.readWord = @"earthquake";
    ...
    if ([wordNameForString isEqualToString:@"27. effective"]) {
        self.readWord = @"effective";
    ...
    if ([wordNameForString isEqualToString:@"27. examine"]) {
        self.readWord = @"examine";
    ...
    if ([wordNameForString isEqualToString:@"27. false"]) {
        self.readWord = @"false";
    ...
    if ([wordNameForString isEqualToString:@"27. gift"]) {
        self.readWord = @"gift";
    ...
    if ([wordNameForString isEqualToString:@"27. hunger"]) {
        self.readWord = @"hunger";
    ...
    if ([wordNameForString isEqualToString:@"27. imagine"]) {
        self.readWord = @"imagine";
    ...
    if ([wordNameForString isEqualToString:@"27. journey"]) {
        self.readWord = @"journey";
    ...
    if ([wordNameForString isEqualToString:@"27. puzzle"]) {
        self.readWord = @"puzzle";
    ...
    if ([wordNameForString isEqualToString:@"27. quite"]) {
        self.readWord = @"quite";
    ...
    if ([wordNameForString isEqualToString:@"27. rather"]) {
        self.readWord = @"rather";
        ewTextView.text =  @"副詞\n~よりもむしろ~, ~というよりは~\n\nむしろ~したい, ~した方がいい\nI would rather stay at home.\n(むしろ)家にいた方がいい。\n\nむしろ~だといいのに\n\nかなり, 相当; やや, いくぶん, 思ったより\n\nもっと正しくは; それどころか";
        [hatuonLabel setText:[NSString stringWithFormat:@"rǽðər|rɑ́ːðə"]];
        reibun =  @"I would rather stay at home.";
    }
    if ([wordNameForString isEqualToString:@"27. specific"]) {
        self.readWord = @"specific";
    ...
    if ([wordNameForString isEqualToString:@"27. value"]) {
        self.readWord = @"value";
    ...
    if ([wordNameForString isEqualToString:@"28. band"]) {
        self.readWord = @"band";
    ...
    if ([wordNameForString isEqualToString:@"28. barely"]) {
        self.readWord = @"barely";
    ...
    if ([wordNameForString isEqualToString:@"28. boring"]) {
        self.readWord = @"boring";
    ...
    if ([wordNameForString isEqualToString:@"28. cancel"]) {
        self.readWord = @"cancel";
    ...
    if ([wordNameForString isEqualToString:@"28. driveway"]) {
        self.readWord = @"driveway";
    ...
    if ([wordNameForString isEqualToString:@"28. garbage"]) {
        self.readWord = @"garbage";
        ewTextView.text =  @"名詞\nごみ\nPlease throw the garbage away.\nそのゴミを捨ててください。\n\n誤ったデータ, 不要データ";
        [hatuonLabel setText:[NSString stringWithFormat:@"ɡɑ́ːrbɪdʒ"]];
        reibun = @"Please throw the garbage away.";
    }
    if ([wordNameForString isEqualToString:@"28. instrument"]) {
        self.readWord = @"instrument";
    ...
    if ([wordNameForString isEqualToString:@"28. list"]) {
        self.readWord = @"list";
    ...
    if ([wordNameForString isEqualToString:@"28. magic"]) {
        self.readWord = @"magic";
    ...
    if ([wordNameForString isEqualToString:@"28. message"]) {
        self.readWord = @"message";
    ...
    if ([wordNameForString isEqualToString:@"28. notice"]) {
        self.readWord = @"notice";
    ...
    if ([wordNameForString isEqualToString:@"28. own"]) {
        self.readWord = @"own";
    ...
    if ([wordNameForString isEqualToString:@"28. predict"]) {
        self.readWord = @"predict";
    ...
    if ([wordNameForString isEqualToString:@"28. professor"]) {
        self.readWord = @"professor";
    ...
    if ([wordNameForString isEqualToString:@"28. rush"]) {
        self.readWord = @"rush";
    ...
    if ([wordNameForString isEqualToString:@"28. schedule"]) {
        self.readWord = @"schedule";
    ...
    if ([wordNameForString isEqualToString:@"28. share"]) {
        self.readWord = @"share";
    ...
    if ([wordNameForString isEqualToString:@"28. stage"]) {
        self.readWord = @"stage";
    ...
    if ([wordNameForString isEqualToString:@"28. storm"]) {
        self.readWord = @"storm";
    ...
    if ([wordNameForString isEqualToString:@"28. within"]) {
        self.readWord = @"within";
    ...
    if ([wordNameForString isEqualToString:@"29. advertise"]) {
        self.readWord = @"advertise";
    ...
    if ([wordNameForString isEqualToString:@"29. assign"]) {
        self.readWord = @"assign";
    ...
    if ([wordNameForString isEqualToString:@"29. audience"]) {
        self.readWord = @"audience";
    ...
    if ([wordNameForString isEqualToString:@"29. breakfast"]) {
        self.readWord = @"breakfast";
        ewTextView.text =  @"名詞\n朝食\nHe seldom eats breakfast.\n彼は朝食を滅多に食べない。";
        [hatuonLabel setText:[NSString stringWithFormat:@"brékfəst"]];
        reibun = @"He seldom eats breakfast.";
    }
    if ([wordNameForString isEqualToString:@"29. competition"]) {
        self.readWord = @"competition";
    ...
    if ([wordNameForString isEqualToString:@"29. cool"]) {
        self.readWord = @"cool";
    ...
    if ([wordNameForString isEqualToString:@"29. knowledge"]) {
        self.readWord = @"knowledge";
    ...
    if ([wordNameForString isEqualToString:@"29. major"]) {
        self.readWord = @"major";
    ...
    if ([wordNameForString isEqualToString:@"29. mean"]) {
        self.readWord = @"mean";
    ...
    if ([wordNameForString isEqualToString:@"29. prefer"]) {
        self.readWord = @"prefer";
    ...
    if ([wordNameForString isEqualToString:@"29. president"]) {
        self.readWord = @"president";
    ...
    if ([wordNameForString isEqualToString:@"29. progress"]) {
        self.readWord = @"progress";
    ...
    if ([wordNameForString isEqualToString:@"29. respect"]) {
        self.readWord = @"respect";
    ...
    if ([wordNameForString isEqualToString:@"29. rich"]) {
        self.readWord = @"rich";
    ...
    if ([wordNameForString isEqualToString:@"29. skill"]) {
        self.readWord = @"skill";
    ...
    if ([wordNameForString isEqualToString:@"29. somehow"]) {
        self.readWord = @"somehow";
    ...
    if ([wordNameForString isEqualToString:@"29. strength"]) {
        self.readWord = @"strength";
    ...
    if ([wordNameForString isEqualToString:@"30. ahead"]) {
        self.readWord = @"ahead";
    ...
    if ([wordNameForString isEqualToString:@"30. amount"]) {
        self.readWord = @"amount";
    ...
    if ([wordNameForString isEqualToString:@"30. belief"]) {
        self.readWord = @"belief";
        ewTextView.text =  @"名詞 複～s/-s/\n信じること, 確信, 信念\n\n信用, 信頼\n\n信仰, 信心; 信条\nHe has lost his belief in God.\n彼は神を信じなくなった。";
        [hatuonLabel setText:[NSString stringWithFormat:@"bɪlíːf, bə-"]];
        reibun = @"He has lost his belief in God.";
    }
    if ([wordNameForString isEqualToString:@"30. center"]) {
        self.readWord = @"center";
    ...
    if ([wordNameForString isEqualToString:@"30. common"]) {
        self.readWord = @"common";
    ...
    if ([wordNameForString isEqualToString:@"30. cost"]) {
        self.readWord = @"cost";
    ...
    if ([wordNameForString isEqualToString:@"30. demonstrate"]) {
        self.readWord = @"demonstrate";
    ...
    if ([wordNameForString isEqualToString:@"30. different"]) {
        self.readWord = @"different";
    ...
    if ([wordNameForString isEqualToString:@"30. evidence"]) {
        self.readWord = @"evidence";
    ...
    if ([wordNameForString isEqualToString:@"30. honesty"]) {
        self.readWord = @"honesty";
        ewTextView.text =  @"名詞 複-ties/-z/\n正直, 誠実, 率直, 公正\nI respect you for your honesty.\n正直であるあなたを尊敬します。";
        [hatuonLabel setText:[NSString stringWithFormat:@"ɑ́nəsti|ɔ́n-"]];
        reibun = @"I respect you for your honesty.";
    }
    if ([wordNameForString isEqualToString:@"30. idiom"]) {
        self.readWord = @"idiom";
        ewTextView.text =  @"熟語, 成句, イディオム, 慣用句";
        [hatuonLabel setText:[NSString stringWithFormat:@"ɪ́diəm"]];
        reibun = @"";
    }
    if ([wordNameForString isEqualToString:@"30. independent"]) {
        self.readWord = @"independent";
    ...
    if ([wordNameForString isEqualToString:@"30. inside"]) {
        self.readWord = @"inside";
    ...
    if ([wordNameForString isEqualToString:@"30. master"]) {
        self.readWord = @"master";
    ...
    if ([wordNameForString isEqualToString:@"30. memory"]) {
        self.readWord = @"memory";
    ...
    if ([wordNameForString isEqualToString:@"30. proper"]) {
        self.readWord = @"proper";
    ...
    if ([wordNameForString isEqualToString:@"30. scan"]) {
        self.readWord = @"scan";
    ...
    if ([wordNameForString isEqualToString:@"26. imply"]) {
        self.readWord = @"imply";
    ...
    if ([wordNameForString isEqualToString:@"30. section"]) {
        self.readWord = @"section";
    ...
    if ([wordNameForString isEqualToString:@"30. surface"]) {
        self.readWord = @"surface";
...
- (IBAction)tangoSaisei:(id)sender {
    if( self.speechSynthesizer.paused){
        ...
        AVSpeechUtterance *utterance = [AVSpeechUtterance speechUtteranceWithString:self.readWord];
